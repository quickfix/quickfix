...
echo [SESSION] >> cfg\at.cfg
echo BeginString=FIXT.1.1 >> cfg\at.cfg
echo TargetCompID=TW50SP1 >> cfg\at.cfg
echo DefaultApplVerID=FIX.5.0SP1 >> cfg\at.cfg
echo TransportDataDictionary=..\spec\FIXT11.xml >> cfg\at.cfg
echo AppDataDictionary=..\spec\FIX50SP1.xml >> cfg\at.cfg
echo [SESSION] >> cfg\at.cfg
echo BeginString=FIXT.1.1 >> cfg\at.cfg
echo TargetCompID=TW50SP2 >> cfg\at.cfg
echo DefaultApplVerID=FIX.5.0SP2 >> cfg\at.cfg
echo TransportDataDictionary=..\spec\FIXT11.xml >> cfg\at.cfg
echo AppDataDictionary=..\spec\FIX50SP2.xml >> cfg\at.cfg
echo [SESSION] >> cfg\at.cfg
echo BeginString=FIX.4.4 >> cfg\at.cfg
...
echo [SESSION] >> cfg\at.cfg
echo BeginString=FIX.4.4 >> cfg\at.cfg
echo TargetCompID=NO_CHECK_FIELDS_HAVE_VALUES >> cfg\at.cfg
echo DataDictionary=..\spec\FIX44.xml >> cfg\at.cfg
echo ValidateFieldsHaveValues=N >> cfg\at.cfg
