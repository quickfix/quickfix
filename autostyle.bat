...
dos2unix examples/tradeclientgui/banzai/src/quickfix/banzai/*.java

astyle --style=java examples\tradeclientgui\banzai\src\org\quickfix\banzai\ui\*.java

dos2unix examples/tradeclientgui/banzai/src/quickfix/banzai/ui/*.java
