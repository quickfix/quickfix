namespace QuickFixT11
{
  ...
  public class Logon : Message
  {
    ...
    public void set(QuickFix.DefaultApplVerID value)
    { setField(value); }
    public QuickFix.DefaultApplVerID get(QuickFix.DefaultApplVerID  value)
    { getField(value); return value; }
    public QuickFix.DefaultApplVerID getDefaultApplVerID()
    { QuickFix.DefaultApplVerID value = new QuickFix.DefaultApplVerID();
      getField(value); return value; }
    public bool isSet(QuickFix.DefaultApplVerID field)
    { return isSetField(field); }
    ...
    static int[] message_order = new int[] {372,385,1130,1131,0};
