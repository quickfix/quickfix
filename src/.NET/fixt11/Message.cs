namespace QuickFixT11
{
  public class Header : QuickFix.Message.Header
  {
    Header(QuickFix.Message message) : base(message) {}
      ...
      public void set(QuickFix.ApplVerID value)
      { setField(value); }
      public QuickFix.ApplVerID get(QuickFix.ApplVerID  value)
      { getField(value); return value; }
      public QuickFix.ApplVerID getApplVerID()
      { QuickFix.ApplVerID value = new QuickFix.ApplVerID();
        getField(value); return value; }
      public bool isSet(QuickFix.ApplVerID field)
      { return isSetField(field); }
      public bool isSetApplVerID()
      { return isSetField(1128); }

      public void set(QuickFix.CstmApplVerID value)
      { setField(value); }
      public QuickFix.CstmApplVerID get(QuickFix.CstmApplVerID  value)
      { getField(value); return value; }
      public QuickFix.CstmApplVerID getCstmApplVerID()
      { QuickFix.CstmApplVerID value = new QuickFix.CstmApplVerID();
        getField(value); return value; }
      public bool isSet(QuickFix.CstmApplVerID field)
      { return isSetField(field); }
      public bool isSetCstmApplVerID()
