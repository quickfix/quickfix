namespace QuickFix50
{
  ...
  public class MarketDataRequest : Message
  {
    ...
    static int[] message_order = new int[] {55,65,48,22,460,461,167,762,200,541,1079,201,966,1049,965,224,225,239,226,227,228,255,543,470,471,472,240,202,947,967,968,206,231,969,996,997,223,207,970,971,106,348,349,107,350,351,691,667,875,876,873,874,711,555,15,537,63,64,271,0};
