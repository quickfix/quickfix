namespace QuickFix50
{
  ...
  public class ContraryIntentionReport : Message
  {
    ...
    static int[] message_order = new int[] {982,983,0};
      public void set(QuickFix.ExpType value)
      { setField(value); }
      public QuickFix.ExpType get(QuickFix.ExpType  value)
      { getField(value); return value; }
      public QuickFix.ExpType getExpType()
      { QuickFix.ExpType value = new QuickFix.ExpType();
        getField(value); return value; }
      public bool isSet(QuickFix.ExpType field)
      { return isSetField(field); }
