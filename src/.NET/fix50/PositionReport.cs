namespace QuickFix50
{
  ...
  public class PositionReport : Message
  {
    ...
    static int[] message_order = new int[] {311,312,309,305,462,463,310,763,313,542,315,241,242,243,244,245,246,256,595,592,593,594,247,316,941,317,436,998,1000,435,308,306,362,363,307,364,365,877,878,972,318,879,975,973,974,810,882,883,884,885,886,1044,1045,1046,1038,1039,732,733,1037,984,0};
      ...
      public void set(QuickFix.UnderlyingDeliveryAmount value)
      { setField(value); }
      public QuickFix.UnderlyingDeliveryAmount get(QuickFix.UnderlyingDeliveryAmount  value)
      { getField(value); return value; }
      public QuickFix.UnderlyingDeliveryAmount getUnderlyingDeliveryAmount()
      { QuickFix.UnderlyingDeliveryAmount value = new QuickFix.UnderlyingDeliveryAmount();
        getField(value); return value; }
      public bool isSet(QuickFix.UnderlyingDeliveryAmount field)
      { return isSetField(field); }
      public bool isSetUnderlyingDeliveryAmount()
      { return isSetField(1037); }

      public void set(QuickFix.NoUnderlyingAmounts value)
      { setField(value); }
      public QuickFix.NoUnderlyingAmounts get(QuickFix.NoUnderlyingAmounts  value)
      { getField(value); return value; }
      public QuickFix.NoUnderlyingAmounts getNoUnderlyingAmounts()
      { QuickFix.NoUnderlyingAmounts value = new QuickFix.NoUnderlyingAmounts();
        getField(value); return value; }
      public bool isSet(QuickFix.NoUnderlyingAmounts field)
      { return isSetField(field); }
      public bool isSetNoUnderlyingAmounts()
      { return isSetField(984); }

      public class NoUnderlyingAmounts: QuickFix.Group
      {
      public NoUnderlyingAmounts() : base(984,985,message_order ) {}
      static int[] message_order = new int[] {985,986,987,988,0};
        public void set(QuickFix.UnderlyingPayAmount value)
        { setField(value); }
        public QuickFix.UnderlyingPayAmount get(QuickFix.UnderlyingPayAmount  value)
        { getField(value); return value; }
        public QuickFix.UnderlyingPayAmount getUnderlyingPayAmount()
        { QuickFix.UnderlyingPayAmount value = new QuickFix.UnderlyingPayAmount();
          getField(value); return value; }
        public bool isSet(QuickFix.UnderlyingPayAmount field)
        { return isSetField(field); }
        public bool isSetUnderlyingPayAmount()
        { return isSetField(985); }

        public void set(QuickFix.UnderlyingCollectAmount value)
        { setField(value); }
        public QuickFix.UnderlyingCollectAmount get(QuickFix.UnderlyingCollectAmount  value)
        { getField(value); return value; }
        public QuickFix.UnderlyingCollectAmount getUnderlyingCollectAmount()
        { QuickFix.UnderlyingCollectAmount value = new QuickFix.UnderlyingCollectAmount();
          getField(value); return value; }
        public bool isSet(QuickFix.UnderlyingCollectAmount field)
        { return isSetField(field); }
        ...
        public void set(QuickFix.UnderlyingSettlementStatus value)
        { setField(value); }
        public QuickFix.UnderlyingSettlementStatus get(QuickFix.UnderlyingSettlementStatus  value)
        { getField(value); return value; }
        public QuickFix.UnderlyingSettlementStatus getUnderlyingSettlementStatus()
        { QuickFix.UnderlyingSettlementStatus value = new QuickFix.UnderlyingSettlementStatus();
          getField(value); return value; }
        public bool isSet(QuickFix.UnderlyingSettlementStatus field)
        { return isSetField(field); }
    ...
    static int[] message_order = new int[] {703,704,705,706,976,539,0};
