namespace QuickFix50Sp1
{
  ...
  {
    public SecurityDefinitionUpdateReport() : base(MsgType()) {}
    static QuickFix.MsgType MsgType() { return new QuickFix.MsgType("BP"); }
    ...
    static int[] message_order = new int[] {600,601,602,603,607,608,609,764,610,611,1212,248,249,250,251,252,253,257,599,596,597,598,254,612,942,613,614,999,1224,1421,1422,1001,1420,615,616,617,618,619,620,621,622,623,624,556,740,739,955,956,1358,1017,566,0};
    ...
    public void set(QuickFix.NoMarketSegments value)
    { setField(value); }
    public QuickFix.NoMarketSegments get(QuickFix.NoMarketSegments  value)
    { getField(value); return value; }
    public QuickFix.NoMarketSegments getNoMarketSegments()
    { QuickFix.NoMarketSegments value = new QuickFix.NoMarketSegments();
      getField(value); return value; }
    public bool isSet(QuickFix.NoMarketSegments field)
    { return isSetField(field); }
    public bool isSetNoMarketSegments()
    { return isSetField(1310); }

    public class NoMarketSegments: QuickFix.Group
    {
    public NoMarketSegments() : base(1310,1301,message_order ) {}
    static int[] message_order = new int[] {1301,1300,1201,0};
