namespace QuickFix50Sp1
{
  ...
  public class CollateralResponse : Message
  {
    ...
    public void set(QuickFix.CollApplType value)
    { setField(value); }
    public QuickFix.CollApplType get(QuickFix.CollApplType  value)
    { getField(value); return value; }
    public QuickFix.CollApplType getCollApplType()
    { QuickFix.CollApplType value = new QuickFix.CollApplType();
      getField(value); return value; }
    public bool isSet(QuickFix.CollApplType field)
    { return isSetField(field); }
    ...
    static int[] message_order = new int[] {311,312,309,305,462,463,310,763,313,542,1213,241,242,243,244,245,246,256,595,592,593,594,247,316,941,317,436,998,1423,1424,1425,1000,1419,435,308,306,362,363,307,364,365,877,878,972,318,879,975,973,974,810,882,883,884,885,886,1044,1045,1046,1038,1039,315,944,0};
