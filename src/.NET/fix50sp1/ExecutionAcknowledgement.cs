namespace QuickFix50Sp1
{
  ...
  {
    public ExecutionAcknowledgement() : base(MsgType()) {}
    static QuickFix.MsgType MsgType() { return new QuickFix.MsgType("BN"); }

    public ExecutionAcknowledgement(
      QuickFix.OrderID aOrderID,
      QuickFix.ExecAckStatus aExecAckStatus,
    ...
    public void set(QuickFix.ExecAckStatus value)
    { setField(value); }
    public QuickFix.ExecAckStatus get(QuickFix.ExecAckStatus  value)
    { getField(value); return value; }
    public QuickFix.ExecAckStatus getExecAckStatus()
    { QuickFix.ExecAckStatus value = new QuickFix.ExecAckStatus();
      getField(value); return value; }
    public bool isSet(QuickFix.ExecAckStatus field)
    { return isSetField(field); }
