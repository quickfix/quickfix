namespace QuickFix50Sp1
{
  ...
  public class SecurityStatus : Message
  {
    ...
    public void set(QuickFix.SecurityTradingEvent value)
    { setField(value); }
    public QuickFix.SecurityTradingEvent get(QuickFix.SecurityTradingEvent  value)
    { getField(value); return value; }
    public QuickFix.SecurityTradingEvent getSecurityTradingEvent()
    { QuickFix.SecurityTradingEvent value = new QuickFix.SecurityTradingEvent();
      getField(value); return value; }
    public bool isSet(QuickFix.SecurityTradingEvent field)
    { return isSetField(field); }
