namespace QuickFix50Sp1
{
  ...
  public class TradeCaptureReportAck : Message
  {
    ...
    static int[] message_order = new int[] {600,601,602,603,607,608,609,764,610,611,1212,248,249,250,251,252,253,257,599,596,597,598,254,612,942,613,614,999,1224,1421,1422,1001,1420,615,616,617,618,619,620,621,622,623,624,556,740,739,955,956,1358,1017,566,687,690,990,1152,683,564,565,539,654,587,588,637,675,1073,1074,1075,1379,1381,1383,1384,1418,1342,0};
    ...
    static int[] message_order = new int[] {54,37,198,11,526,66,453,1,660,581,81,575,1093,576,578,579,821,376,377,528,529,582,40,18,483,336,625,943,430,1154,1155,12,13,479,497,157,230,158,159,738,920,921,922,238,237,118,119,155,156,77,752,518,232,136,825,1158,826,591,70,78,1072,1057,1009,1005,1006,1007,83,1008,1016,0};
      ...
      public void set(QuickFix.SideQty value)
      { setField(value); }
      public QuickFix.SideQty get(QuickFix.SideQty  value)
      { getField(value); return value; }
      public QuickFix.SideQty getSideQty()
      { QuickFix.SideQty value = new QuickFix.SideQty();
        getField(value); return value; }
      public bool isSet(QuickFix.SideQty field)
      { return isSetField(field); }
    ...
    public void set(QuickFix.RptSys value)
    { setField(value); }
    public QuickFix.RptSys get(QuickFix.RptSys  value)
    { getField(value); return value; }
    public QuickFix.RptSys getRptSys()
    { QuickFix.RptSys value = new QuickFix.RptSys();
      getField(value); return value; }
    public bool isSet(QuickFix.RptSys field)
    { return isSetField(field); }
