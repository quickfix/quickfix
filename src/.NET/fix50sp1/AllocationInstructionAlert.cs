namespace QuickFix50Sp1
{
  ...
  {
    public AllocationInstructionAlert() : base(MsgType()) {}
    static QuickFix.MsgType MsgType() { return new QuickFix.MsgType("BM"); }
    ...
    static int[] message_order = new int[] {32,17,527,31,669,29,1003,1041,0};
    ...
    static int[] message_order = new int[] {79,661,573,366,80,467,81,989,1002,993,1047,992,539,208,209,161,360,361,12,13,479,497,153,154,119,737,120,736,155,156,742,741,136,576,635,780,172,169,170,171,0};
