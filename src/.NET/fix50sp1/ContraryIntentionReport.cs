namespace QuickFix50Sp1
{
  ...
  {
    public ContraryIntentionReport() : base(MsgType()) {}
    static QuickFix.MsgType MsgType() { return new QuickFix.MsgType("BO"); }

    public ContraryIntentionReport(
      QuickFix.ContIntRptID aContIntRptID,
    ...
    public void set(QuickFix.ContIntRptID value)
    { setField(value); }
    public QuickFix.ContIntRptID get(QuickFix.ContIntRptID  value)
    { getField(value); return value; }
    public QuickFix.ContIntRptID getContIntRptID()
    { QuickFix.ContIntRptID value = new QuickFix.ContIntRptID();
      getField(value); return value; }
    public bool isSet(QuickFix.ContIntRptID field)
    { return isSetField(field); }
    ...
    public void set(QuickFix.LateIndicator value)
    { setField(value); }
    public QuickFix.LateIndicator get(QuickFix.LateIndicator  value)
    { getField(value); return value; }
    public QuickFix.LateIndicator getLateIndicator()
    { QuickFix.LateIndicator value = new QuickFix.LateIndicator();
      getField(value); return value; }
    public bool isSet(QuickFix.LateIndicator field)
    { return isSetField(field); }
    public bool isSetLateIndicator()
    { return isSetField(978); }

    public void set(QuickFix.InputSource value)
    { setField(value); }
    public QuickFix.InputSource get(QuickFix.InputSource  value)
    { getField(value); return value; }
    public QuickFix.InputSource getInputSource()
    { QuickFix.InputSource value = new QuickFix.InputSource();
      getField(value); return value; }
    public bool isSet(QuickFix.InputSource field)
    { return isSetField(field); }
    ...
    public void set(QuickFix.NoExpiration value)
    { setField(value); }
    public QuickFix.NoExpiration get(QuickFix.NoExpiration  value)
    { getField(value); return value; }
    public QuickFix.NoExpiration getNoExpiration()
    { QuickFix.NoExpiration value = new QuickFix.NoExpiration();
      getField(value); return value; }
    public bool isSet(QuickFix.NoExpiration field)
    { return isSetField(field); }
    public bool isSetNoExpiration()
    { return isSetField(981); }

    public class NoExpiration: QuickFix.Group
    {
    public NoExpiration() : base(981,982,message_order ) {}
    static int[] message_order = new int[] {982,983,0};
      public void set(QuickFix.ExpirationQtyType value)
      { setField(value); }
      public QuickFix.ExpirationQtyType get(QuickFix.ExpirationQtyType  value)
      { getField(value); return value; }
      public QuickFix.ExpirationQtyType getExpirationQtyType()
      { QuickFix.ExpirationQtyType value = new QuickFix.ExpirationQtyType();
        getField(value); return value; }
      public bool isSet(QuickFix.ExpirationQtyType field)
      { return isSetField(field); }
      public bool isSetExpirationQtyType()
      { return isSetField(982); }

      public void set(QuickFix.ExpQty value)
      { setField(value); }
      public QuickFix.ExpQty get(QuickFix.ExpQty  value)
      { getField(value); return value; }
      public QuickFix.ExpQty getExpQty()
      { QuickFix.ExpQty value = new QuickFix.ExpQty();
        getField(value); return value; }
      public bool isSet(QuickFix.ExpQty field)
      { return isSetField(field); }
