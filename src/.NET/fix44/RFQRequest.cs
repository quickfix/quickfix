namespace QuickFix44
{
  ...
  public class RFQRequest : Message
  {
    ...
    static int[] message_order = new int[] {55,65,48,22,460,461,167,762,200,541,201,224,225,239,226,227,228,255,543,470,471,472,240,202,947,206,231,223,207,106,348,349,107,350,351,691,667,875,876,873,874,711,555,140,303,537,336,625,0};
