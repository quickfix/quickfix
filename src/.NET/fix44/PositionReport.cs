namespace QuickFix44
{
  ...
  public class PositionReport : Message
  {
    ...
    static int[] message_order = new int[] {703,704,705,706,0};
    ...
    static int[] message_order = new int[] {311,312,309,305,462,463,310,763,313,542,241,242,243,244,245,246,256,595,592,593,594,247,316,941,317,436,435,308,306,362,363,307,364,365,877,878,318,879,810,882,883,884,885,886,732,733,0};
