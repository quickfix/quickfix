namespace QuickFix43
{
  ...
  public class MassQuoteAcknowledgement : Message
  {
    ...
    static int[] message_order = new int[] {302,311,312,309,305,457,462,463,310,313,542,241,242,243,244,245,246,256,595,592,593,594,247,315,316,317,436,435,308,306,362,363,307,364,365,304,295,0};
