namespace QuickFix50Sp2
{
  ...
  {
    public StreamAssignmentReport() : base(MsgType()) {}
    static QuickFix.MsgType MsgType() { return new QuickFix.MsgType("CD"); }
    ...
    public void set(QuickFix.StreamAsgnReqType value)
    { setField(value); }
    public QuickFix.StreamAsgnReqType get(QuickFix.StreamAsgnReqType  value)
    { getField(value); return value; }
    public QuickFix.StreamAsgnReqType getStreamAsgnReqType()
    { QuickFix.StreamAsgnReqType value = new QuickFix.StreamAsgnReqType();
      getField(value); return value; }
    public bool isSet(QuickFix.StreamAsgnReqType field)
    { return isSetField(field); }
    public bool isSetStreamAsgnReqType()
    { return isSetField(1498); }

    public void set(QuickFix.StreamAsgnReqID value)
    { setField(value); }
    public QuickFix.StreamAsgnReqID get(QuickFix.StreamAsgnReqID  value)
    { getField(value); return value; }
    public QuickFix.StreamAsgnReqID getStreamAsgnReqID()
    { QuickFix.StreamAsgnReqID value = new QuickFix.StreamAsgnReqID();
      getField(value); return value; }
    public bool isSet(QuickFix.StreamAsgnReqID field)
    { return isSetField(field); }
    public bool isSetStreamAsgnReqID()
    { return isSetField(1497); }

    public void set(QuickFix.NoAsgnReqs value)
    { setField(value); }
    public QuickFix.NoAsgnReqs get(QuickFix.NoAsgnReqs  value)
    { getField(value); return value; }
    public QuickFix.NoAsgnReqs getNoAsgnReqs()
    { QuickFix.NoAsgnReqs value = new QuickFix.NoAsgnReqs();
      getField(value); return value; }
    public bool isSet(QuickFix.NoAsgnReqs field)
    { return isSetField(field); }
    public bool isSetNoAsgnReqs()
    { return isSetField(1499); }

    public class NoAsgnReqs: QuickFix.Group
    {
    public NoAsgnReqs() : base(1499,453,message_order ) {}
    static int[] message_order = new int[] {453,146,0};
      ...
      static int[] message_order = new int[] {55,65,48,22,460,1227,1151,461,167,762,200,541,1079,966,1049,965,224,225,239,226,227,228,255,543,470,471,472,240,202,947,967,968,206,231,969,1146,996,1147,1191,1192,1193,1194,1195,1196,1197,1198,1199,1200,201,1244,1242,997,223,207,970,971,106,348,349,107,350,351,691,667,875,876,873,874,1435,1439,1449,1450,1451,1452,1457,1458,1478,1479,1480,1481,1482,63,1617,1500,1502,58,354,355,0};
        ...
        public void set(QuickFix.StreamAsgnType value)
        { setField(value); }
        public QuickFix.StreamAsgnType get(QuickFix.StreamAsgnType  value)
        { getField(value); return value; }
        public QuickFix.StreamAsgnType getStreamAsgnType()
        { QuickFix.StreamAsgnType value = new QuickFix.StreamAsgnType();
          getField(value); return value; }
        public bool isSet(QuickFix.StreamAsgnType field)
        { return isSetField(field); }
