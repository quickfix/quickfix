namespace QuickFix50Sp2
{
  ...
  {
    public StreamAssignmentRequest() : base(MsgType()) {}
    static QuickFix.MsgType MsgType() { return new QuickFix.MsgType("CC"); }

    public StreamAssignmentRequest(
      QuickFix.StreamAsgnReqID aStreamAsgnReqID,
      QuickFix.StreamAsgnReqType aStreamAsgnReqType )
    : base(MsgType()) {
