namespace QuickFix50Sp2
{
  ...
  {
    public OrderMassActionReport() : base(MsgType()) {}
    static QuickFix.MsgType MsgType() { return new QuickFix.MsgType("BZ"); }

    public OrderMassActionReport(
      QuickFix.MassActionReportID aMassActionReportID,
      QuickFix.MassActionType aMassActionType,
      QuickFix.MassActionScope aMassActionScope,
      QuickFix.MassActionResponse aMassActionResponse )
    : base(MsgType()) {
    ...
    public void set(QuickFix.MassActionReportID value)
    { setField(value); }
    public QuickFix.MassActionReportID get(QuickFix.MassActionReportID  value)
    { getField(value); return value; }
    public QuickFix.MassActionReportID getMassActionReportID()
    { QuickFix.MassActionReportID value = new QuickFix.MassActionReportID();
      getField(value); return value; }
    public bool isSet(QuickFix.MassActionReportID field)
    { return isSetField(field); }
    public bool isSetMassActionReportID()
    { return isSetField(1369); }

    public void set(QuickFix.MassActionType value)
    { setField(value); }
    public QuickFix.MassActionType get(QuickFix.MassActionType  value)
    { getField(value); return value; }
    public QuickFix.MassActionType getMassActionType()
    { QuickFix.MassActionType value = new QuickFix.MassActionType();
      getField(value); return value; }
    public bool isSet(QuickFix.MassActionType field)
    { return isSetField(field); }
    public bool isSetMassActionType()
    { return isSetField(1373); }

    public void set(QuickFix.MassActionScope value)
    { setField(value); }
    public QuickFix.MassActionScope get(QuickFix.MassActionScope  value)
    { getField(value); return value; }
    public QuickFix.MassActionScope getMassActionScope()
    { QuickFix.MassActionScope value = new QuickFix.MassActionScope();
      getField(value); return value; }
    public bool isSet(QuickFix.MassActionScope field)
    { return isSetField(field); }
    public bool isSetMassActionScope()
    { return isSetField(1374); }

    public void set(QuickFix.MassActionResponse value)
    { setField(value); }
    public QuickFix.MassActionResponse get(QuickFix.MassActionResponse  value)
    { getField(value); return value; }
    public QuickFix.MassActionResponse getMassActionResponse()
    { QuickFix.MassActionResponse value = new QuickFix.MassActionResponse();
      getField(value); return value; }
    public bool isSet(QuickFix.MassActionResponse field)
    { return isSetField(field); }
    public bool isSetMassActionResponse()
    { return isSetField(1375); }

    public void set(QuickFix.MassActionRejectReason value)
    { setField(value); }
    public QuickFix.MassActionRejectReason get(QuickFix.MassActionRejectReason  value)
    { getField(value); return value; }
    public QuickFix.MassActionRejectReason getMassActionRejectReason()
    { QuickFix.MassActionRejectReason value = new QuickFix.MassActionRejectReason();
      getField(value); return value; }
    public bool isSet(QuickFix.MassActionRejectReason field)
    { return isSetField(field); }
    ...
    public void set(QuickFix.NoNotAffectedOrders value)
    { setField(value); }
    public QuickFix.NoNotAffectedOrders get(QuickFix.NoNotAffectedOrders  value)
    { getField(value); return value; }
    public QuickFix.NoNotAffectedOrders getNoNotAffectedOrders()
    { QuickFix.NoNotAffectedOrders value = new QuickFix.NoNotAffectedOrders();
      getField(value); return value; }
    public bool isSet(QuickFix.NoNotAffectedOrders field)
    { return isSetField(field); }
    public bool isSetNoNotAffectedOrders()
    { return isSetField(1370); }

    public class NoNotAffectedOrders: QuickFix.Group
    {
    public NoNotAffectedOrders() : base(1370,1372,message_order ) {}
    static int[] message_order = new int[] {1372,1371,0};
      public void set(QuickFix.NotAffOrigClOrdID value)
      { setField(value); }
      public QuickFix.NotAffOrigClOrdID get(QuickFix.NotAffOrigClOrdID  value)
      { getField(value); return value; }
      public QuickFix.NotAffOrigClOrdID getNotAffOrigClOrdID()
      { QuickFix.NotAffOrigClOrdID value = new QuickFix.NotAffOrigClOrdID();
        getField(value); return value; }
      public bool isSet(QuickFix.NotAffOrigClOrdID field)
      { return isSetField(field); }
      public bool isSetNotAffOrigClOrdID()
      { return isSetField(1372); }

      public void set(QuickFix.NotAffectedOrderID value)
      { setField(value); }
      public QuickFix.NotAffectedOrderID get(QuickFix.NotAffectedOrderID  value)
      { getField(value); return value; }
      public QuickFix.NotAffectedOrderID getNotAffectedOrderID()
      { QuickFix.NotAffectedOrderID value = new QuickFix.NotAffectedOrderID();
        getField(value); return value; }
      public bool isSet(QuickFix.NotAffectedOrderID field)
      { return isSetField(field); }
      public bool isSetNotAffectedOrderID()
      { return isSetField(1371); }

    };
    public void set(QuickFix.NoTargetPartyIDs value)
    { setField(value); }
    public QuickFix.NoTargetPartyIDs get(QuickFix.NoTargetPartyIDs  value)
    { getField(value); return value; }
    public QuickFix.NoTargetPartyIDs getNoTargetPartyIDs()
    { QuickFix.NoTargetPartyIDs value = new QuickFix.NoTargetPartyIDs();
      getField(value); return value; }
    public bool isSet(QuickFix.NoTargetPartyIDs field)
    { return isSetField(field); }
    public bool isSetNoTargetPartyIDs()
    { return isSetField(1461); }

    public class NoTargetPartyIDs: QuickFix.Group
    {
    public NoTargetPartyIDs() : base(1461,1462,message_order ) {}
    static int[] message_order = new int[] {1462,1463,1464,0};
      public void set(QuickFix.TargetPartyID value)
      { setField(value); }
      public QuickFix.TargetPartyID get(QuickFix.TargetPartyID  value)
      { getField(value); return value; }
      public QuickFix.TargetPartyID getTargetPartyID()
      { QuickFix.TargetPartyID value = new QuickFix.TargetPartyID();
        getField(value); return value; }
      public bool isSet(QuickFix.TargetPartyID field)
      { return isSetField(field); }
      public bool isSetTargetPartyID()
      { return isSetField(1462); }

      public void set(QuickFix.TargetPartyIDSource value)
      { setField(value); }
      public QuickFix.TargetPartyIDSource get(QuickFix.TargetPartyIDSource  value)
      { getField(value); return value; }
      public QuickFix.TargetPartyIDSource getTargetPartyIDSource()
      { QuickFix.TargetPartyIDSource value = new QuickFix.TargetPartyIDSource();
        getField(value); return value; }
      public bool isSet(QuickFix.TargetPartyIDSource field)
      { return isSetField(field); }
      public bool isSetTargetPartyIDSource()
      { return isSetField(1463); }

      public void set(QuickFix.TargetPartyRole value)
      { setField(value); }
      public QuickFix.TargetPartyRole get(QuickFix.TargetPartyRole  value)
      { getField(value); return value; }
      public QuickFix.TargetPartyRole getTargetPartyRole()
      { QuickFix.TargetPartyRole value = new QuickFix.TargetPartyRole();
        getField(value); return value; }
      public bool isSet(QuickFix.TargetPartyRole field)
      { return isSetField(field); }
