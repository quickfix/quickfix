namespace QuickFix50Sp2
{
  ...
  public class News : Message
  {
    ...
    public void set(QuickFix.NewsID value)
    { setField(value); }
    public QuickFix.NewsID get(QuickFix.NewsID  value)
    { getField(value); return value; }
    public QuickFix.NewsID getNewsID()
    { QuickFix.NewsID value = new QuickFix.NewsID();
      getField(value); return value; }
    public bool isSet(QuickFix.NewsID field)
    { return isSetField(field); }
    public bool isSetNewsID()
    { return isSetField(1472); }

    public void set(QuickFix.NoNewsRefIDs value)
    { setField(value); }
    public QuickFix.NoNewsRefIDs get(QuickFix.NoNewsRefIDs  value)
    { getField(value); return value; }
    public QuickFix.NoNewsRefIDs getNoNewsRefIDs()
    { QuickFix.NoNewsRefIDs value = new QuickFix.NoNewsRefIDs();
      getField(value); return value; }
    public bool isSet(QuickFix.NoNewsRefIDs field)
    { return isSetField(field); }
    public bool isSetNoNewsRefIDs()
    { return isSetField(1475); }

    public class NoNewsRefIDs: QuickFix.Group
    {
    public NoNewsRefIDs() : base(1475,1476,message_order ) {}
    static int[] message_order = new int[] {1476,1477,0};
      public void set(QuickFix.NewsRefID value)
      { setField(value); }
      public QuickFix.NewsRefID get(QuickFix.NewsRefID  value)
      { getField(value); return value; }
      public QuickFix.NewsRefID getNewsRefID()
      { QuickFix.NewsRefID value = new QuickFix.NewsRefID();
        getField(value); return value; }
      public bool isSet(QuickFix.NewsRefID field)
      { return isSetField(field); }
      public bool isSetNewsRefID()
      { return isSetField(1476); }

      public void set(QuickFix.NewsRefType value)
      { setField(value); }
      public QuickFix.NewsRefType get(QuickFix.NewsRefType  value)
      { getField(value); return value; }
      public QuickFix.NewsRefType getNewsRefType()
      { QuickFix.NewsRefType value = new QuickFix.NewsRefType();
        getField(value); return value; }
      public bool isSet(QuickFix.NewsRefType field)
      { return isSetField(field); }
      public bool isSetNewsRefType()
      { return isSetField(1477); }

    };
    public void set(QuickFix.NewsCategory value)
    { setField(value); }
    public QuickFix.NewsCategory get(QuickFix.NewsCategory  value)
    { getField(value); return value; }
    public QuickFix.NewsCategory getNewsCategory()
    { QuickFix.NewsCategory value = new QuickFix.NewsCategory();
      getField(value); return value; }
    public bool isSet(QuickFix.NewsCategory field)
    { return isSetField(field); }
    public bool isSetNewsCategory()
    { return isSetField(1473); }

    public void set(QuickFix.LanguageCode value)
    { setField(value); }
    public QuickFix.LanguageCode get(QuickFix.LanguageCode  value)
    { getField(value); return value; }
    public QuickFix.LanguageCode getLanguageCode()
    { QuickFix.LanguageCode value = new QuickFix.LanguageCode();
      getField(value); return value; }
    public bool isSet(QuickFix.LanguageCode field)
    { return isSetField(field); }
