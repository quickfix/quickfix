namespace QuickFix50Sp2
{
  ...
  public class MassQuoteAcknowledgement : Message
  {
    ...
    static int[] message_order = new int[] {302,311,312,309,305,462,463,310,763,313,542,241,242,243,244,245,246,256,595,592,593,594,247,316,941,317,436,435,308,306,362,363,307,364,365,877,878,318,879,810,882,883,884,885,886,972,975,973,974,998,1000,1038,1039,1044,1045,1046,1213,315,1419,1423,1424,1425,1437,1441,1453,1454,1455,1456,1459,1460,304,893,295,1168,1169,1170,367,0};
      ...
      static int[] message_order = new int[] {299,55,65,48,22,460,461,167,762,200,541,224,225,239,226,227,228,255,543,470,471,472,240,202,947,206,231,223,207,106,348,349,107,350,351,691,667,875,876,873,874,965,966,1049,967,968,969,970,971,996,997,1079,1151,1146,1147,1227,1191,1192,1193,1194,1195,1196,1198,1199,1200,201,1244,1242,1197,1435,1439,1449,1450,1451,1452,1457,1458,1478,1479,1480,1481,1482,555,132,133,134,135,62,188,190,189,191,631,632,633,634,60,336,625,64,40,193,192,642,643,15,368,1167,775,528,529,0};
        ...
        public void set(QuickFix.QuoteEntryStatus value)
        { setField(value); }
        public QuickFix.QuoteEntryStatus get(QuickFix.QuoteEntryStatus  value)
        { getField(value); return value; }
        public QuickFix.QuoteEntryStatus getQuoteEntryStatus()
        { QuickFix.QuoteEntryStatus value = new QuickFix.QuoteEntryStatus();
          getField(value); return value; }
        public bool isSet(QuickFix.QuoteEntryStatus field)
        { return isSetField(field); }
      ...
      public void set(QuickFix.TotNoCxldQuotes value)
      { setField(value); }
      public QuickFix.TotNoCxldQuotes get(QuickFix.TotNoCxldQuotes  value)
      { getField(value); return value; }
      public QuickFix.TotNoCxldQuotes getTotNoCxldQuotes()
      { QuickFix.TotNoCxldQuotes value = new QuickFix.TotNoCxldQuotes();
        getField(value); return value; }
      public bool isSet(QuickFix.TotNoCxldQuotes field)
      { return isSetField(field); }
      public bool isSetTotNoCxldQuotes()
      { return isSetField(1168); }

      public void set(QuickFix.TotNoAccQuotes value)
      { setField(value); }
      public QuickFix.TotNoAccQuotes get(QuickFix.TotNoAccQuotes  value)
      { getField(value); return value; }
      public QuickFix.TotNoAccQuotes getTotNoAccQuotes()
      { QuickFix.TotNoAccQuotes value = new QuickFix.TotNoAccQuotes();
        getField(value); return value; }
      public bool isSet(QuickFix.TotNoAccQuotes field)
      { return isSetField(field); }
      public bool isSetTotNoAccQuotes()
      { return isSetField(1169); }

      public void set(QuickFix.TotNoRejQuotes value)
      { setField(value); }
      public QuickFix.TotNoRejQuotes get(QuickFix.TotNoRejQuotes  value)
      { getField(value); return value; }
      public QuickFix.TotNoRejQuotes getTotNoRejQuotes()
      { QuickFix.TotNoRejQuotes value = new QuickFix.TotNoRejQuotes();
        getField(value); return value; }
      public bool isSet(QuickFix.TotNoRejQuotes field)
      { return isSetField(field); }
