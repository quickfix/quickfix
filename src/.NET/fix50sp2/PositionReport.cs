namespace QuickFix50Sp2
{
  ...
  public class PositionReport : Message
  {
    ...
    public void set(QuickFix.ModelType value)
    { setField(value); }
    public QuickFix.ModelType get(QuickFix.ModelType  value)
    { getField(value); return value; }
    public QuickFix.ModelType getModelType()
    { QuickFix.ModelType value = new QuickFix.ModelType();
      getField(value); return value; }
    public bool isSet(QuickFix.ModelType field)
    { return isSetField(field); }
