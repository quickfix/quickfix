...
#include "JVM.h"
#include "quickfix_PostgreSQLLogFactory.h"
...
{ QF_STACK_TRY
  ...
  FIX::LogFactory* pFactory = new FIX::PostgreSQLLogFactory( *pSettings );
...
{ QF_STACK_TRY
  ...
  FIX::PostgreSQLLogFactory* pFactory
  = ( FIX::PostgreSQLLogFactory* ) jobject.getLong( "cppPointer" );
  delete pFactory;
...
{ QF_STACK_TRY
  ...
  FIX::PostgreSQLLogFactory* pFactory
  = ( FIX::PostgreSQLLogFactory* ) jobj.getLong( "cppPointer" );
