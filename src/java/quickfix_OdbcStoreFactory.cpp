...
#include "JVM.h"
#include "quickfix_OdbcStoreFactory.h"
...
{ QF_STACK_TRY
  ...
  FIX::MessageStoreFactory* pFactory = new FIX::OdbcStoreFactory( *pSettings );
...
{ QF_STACK_TRY
  ...
  FIX::OdbcStoreFactory* pFactory
  = ( FIX::OdbcStoreFactory* ) jobject.getLong( "cppPointer" );
  delete pFactory;
...
{ QF_STACK_TRY
  ...
  FIX::OdbcStoreFactory* pFactory
  = ( FIX::OdbcStoreFactory* ) jobj.getLong( "cppPointer" );
