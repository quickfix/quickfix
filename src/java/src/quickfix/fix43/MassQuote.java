...
public class MassQuote extends Message
{
  ...
  public static class NoQuoteSets extends Group {
    public NoQuoteSets() {
      super(296,302,
      new int[] {302,311,312,309,305,462,463,310,313,542,241,242,243,244,245,246,256,595,592,593,594,247,315,316,317,436,435,308,306,362,363,307,364,365,367,304,0 } ); }
  ...
  { setField(value); }
  public org.quickfix.field.TotQuoteEntries get(org.quickfix.field.TotQuoteEntries  value)
    throws FieldNotFound
  { getField(value); return value; }
  ...
  public static class NoQuoteEntries extends Group {
    public NoQuoteEntries() {
      super(295,299,
      new int[] {299,55,65,48,22,460,461,167,200,541,224,225,239,226,227,228,255,543,470,471,472,240,202,206,231,223,207,106,348,349,107,350,351,132,133,134,135,62,188,190,189,191,631,632,633,634,60,336,625,64,40,193,192,642,643,15,0 } ); }
