...
public class ListStrikePrice extends Message
{
  ...
  { setField(value); }
  public org.quickfix.field.TotNoStrikes get(org.quickfix.field.TotNoStrikes  value)
    throws FieldNotFound
  { getField(value); return value; }
  ...
  { setField(value); }
  public org.quickfix.field.NoStrikes get(org.quickfix.field.NoStrikes  value)
    throws FieldNotFound
  { getField(value); return value; }
  ...
  public static class NoStrikes extends Group {
    public NoStrikes() {
      super(428,55,
      new int[] {55,65,48,22,460,461,167,200,541,224,225,239,226,227,228,255,543,470,471,472,240,202,206,231,223,207,106,348,349,107,350,351,140,11,526,54,44,15,58,354,355,0 } ); }
