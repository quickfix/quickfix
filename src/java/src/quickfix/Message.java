...
public class Message extends FieldMap {
    ...
    public native void headerReplaceGroup(int num, Group group);
    ...
    public native void trailerReplaceGroup(int num, Group group);
