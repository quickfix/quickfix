...
public class SecurityListUpdateReport extends Message
{
  ...
  {
    getHeader().setField(new MsgType("BK"));
  }

  public void set(quickfix.field.SecurityReportID value)
  { setField(value); }
  public quickfix.field.SecurityReportID get(quickfix.field.SecurityReportID  value)
  ...
  { setField(value); }
  public quickfix.field.SecurityRequestResult get(quickfix.field.SecurityRequestResult  value)
    throws FieldNotFound
  { getField(value); return value; }
  ...
  { setField(value); }
  public quickfix.field.TotNoRelatedSym get(quickfix.field.TotNoRelatedSym  value)
    throws FieldNotFound
  { getField(value); return value; }
  ...
  { setField(value); }
  public quickfix.field.SecurityUpdateAction get(quickfix.field.SecurityUpdateAction  value)
    throws FieldNotFound
  { getField(value); return value; }
  ...
  public static class NoRelatedSym extends Group {
    public NoRelatedSym() {
      super(146,55,
      new int[] {55,65,48,22,460,461,167,762,200,541,224,225,239,226,227,228,255,543,470,471,472,240,202,947,206,231,223,207,106,348,349,107,350,351,691,667,875,876,873,874,965,966,1049,967,968,969,970,971,996,997,1079,668,869,913,914,915,918,788,916,917,919,898,555,218,220,221,222,662,663,699,761,235,236,701,696,697,698,561,562,336,625,827,58,354,355,311,312,309,305,462,463,310,763,313,542,241,242,243,244,245,246,256,595,592,593,594,247,316,941,317,436,435,308,306,362,363,307,364,365,877,878,318,879,810,882,883,884,885,886,972,975,973,974,998,1000,1038,1039,1044,1045,1046,15,232,0 } ); }
  ...
  public static class NoLegs extends Group {
    public NoLegs() {
      super(555,600,
      new int[] {600,601,602,603,607,608,609,764,610,611,248,249,250,251,252,253,257,599,596,597,598,254,612,942,613,614,615,616,617,618,619,620,621,622,623,624,556,740,739,955,956,999,1001,690,587,683,676,677,678,679,680,0 } ); }
  ...
  { setField(value); }
  public quickfix.field.ExpirationCycle get(quickfix.field.ExpirationCycle  value)
    throws FieldNotFound
  { getField(value); return value; }
