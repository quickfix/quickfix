...
public class MarketDataIncrementalRefresh extends Message
{
  ...
  public static class NoMDEntries extends Group {
    public NoMDEntries() {
      super(268,279,
      new int[] {279,285,269,278,280,55,65,48,22,460,461,167,762,200,541,224,225,239,226,227,228,255,543,470,471,472,240,202,947,206,231,223,207,106,348,349,107,350,351,691,667,875,876,873,874,965,966,1049,967,968,969,970,971,996,997,1079,711,555,291,292,270,15,271,272,273,274,275,336,625,276,277,282,283,284,286,59,432,126,110,18,287,37,299,288,289,346,290,546,811,451,58,354,355,528,1024,332,333,1020,63,64,1070,83,1048,1026,1027,1023,453,198,40,0 } ); }
  ...
  { setField(value); }
  public quickfix.field.OpenCloseSettlFlag get(quickfix.field.OpenCloseSettlFlag  value)
    throws FieldNotFound
  { getField(value); return value; }
  ...
  { setField(value); }
  public quickfix.field.MDOriginType get(quickfix.field.MDOriginType  value)
    throws FieldNotFound
  { getField(value); return value; }
  ...
  { setField(value); }
  public quickfix.field.DealingCapacity get(quickfix.field.DealingCapacity  value)
    throws FieldNotFound
  { getField(value); return value; }
  ...
  { setField(value); }
  public quickfix.field.MDEntrySpotRate get(quickfix.field.MDEntrySpotRate  value)
    throws FieldNotFound
  { getField(value); return value; }
  ...
  { setField(value); }
  public quickfix.field.MDEntryForwardPoints get(quickfix.field.MDEntryForwardPoints  value)
    throws FieldNotFound
  { getField(value); return value; }
  ...
  { setField(value); }
  public quickfix.field.MDPriceLevel get(quickfix.field.MDPriceLevel  value)
    throws FieldNotFound
  { getField(value); return value; }
  ...
  { setField(value); }
  public quickfix.field.ApplQueueDepth get(quickfix.field.ApplQueueDepth  value)
    throws FieldNotFound
  { getField(value); return value; }
  ...
  { setField(value); }
  public quickfix.field.ApplQueueResolution get(quickfix.field.ApplQueueResolution  value)
    throws FieldNotFound
  { getField(value); return value; }
