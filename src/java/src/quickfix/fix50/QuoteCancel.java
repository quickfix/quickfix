...
public class QuoteCancel extends Message
{
  ...
  public QuoteCancel(
    quickfix.field.QuoteCancelType aQuoteCancelType ) {
  ...
  { setField(value); }
  public quickfix.field.QuoteCancelType get(quickfix.field.QuoteCancelType  value)
    throws FieldNotFound
  { getField(value); return value; }
  ...
  public static class NoQuoteEntries extends Group {
    public NoQuoteEntries() {
      super(295,55,
      new int[] {55,65,48,22,460,461,167,762,200,541,224,225,239,226,227,228,255,543,470,471,472,240,202,947,206,231,223,207,106,348,349,107,350,351,691,667,875,876,873,874,965,966,1049,967,968,969,970,971,996,997,1079,913,914,915,918,788,916,917,919,898,711,555,0 } ); }
