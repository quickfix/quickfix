...
public class OrderMassStatusRequest extends Message
{
  ...
  public OrderMassStatusRequest(
    quickfix.field.MassStatusReqID aMassStatusReqID,
    quickfix.field.MassStatusReqType aMassStatusReqType ) {
  ...
  { setField(value); }
  public quickfix.field.MassStatusReqType get(quickfix.field.MassStatusReqType  value)
    throws FieldNotFound
  { getField(value); return value; }
