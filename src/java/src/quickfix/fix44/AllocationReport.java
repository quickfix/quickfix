...
public class AllocationReport extends Message
{
  ...
  public AllocationReport(
    ...
    quickfix.field.AllocReportType aAllocReportType,
    quickfix.field.AllocStatus aAllocStatus,
    quickfix.field.AllocNoOrdersType aAllocNoOrdersType,
  ...
  { setField(value); }
  public quickfix.field.AllocReportRefID get(quickfix.field.AllocReportRefID  value)
    throws FieldNotFound
  { getField(value); return value; }
