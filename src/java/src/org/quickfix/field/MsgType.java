...
public static final String ALLOCATION_REPORT_ACK = "AS"; 
public static final String CONFIRMATION = "AK"; 
public static final String CONFIRMATION_ACK = "AU"; 
public static final String CONFIRMATION_REQUEST = "BS"; 
...
public static final String POSITION_REPORT = "AO"; 
...
public static final String COLLATERAL_INQUIRY_ACK = "BB"; 
