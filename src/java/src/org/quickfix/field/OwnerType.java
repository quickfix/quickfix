...
public static final int INDIV_INVESTOR = 1; 
public static final int PUBLIC_COMPANY = 2; 
public static final int PRIVATE_COMPANY = 3; 
public static final int INDIV_TRUSTEE = 4; 
public static final int COMPANY_TRUSTEE = 5; 
public static final int PENSION_PLAN = 6; 
public static final int CUSTODIAN_MINORS_ACT = 7; 
public static final int TRUSTS = 8; 
public static final int FIDUCIARIES = 9; 
public static final int NETWORKING_SUB_ACCT = 10; 
public static final int NON_PROFIT_ORG = 11; 
public static final int CORP_BODY = 12; 
