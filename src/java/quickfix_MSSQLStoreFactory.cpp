...
#include "JVM.h"
#include "quickfix_MSSQLStoreFactory.h"
...
{ QF_STACK_TRY
  ...
  FIX::MessageStoreFactory* pFactory = new FIX::MSSQLStoreFactory( *pSettings );
...
{ QF_STACK_TRY
  ...
  FIX::MSSQLStoreFactory* pFactory
  = ( FIX::MSSQLStoreFactory* ) jobject.getLong( "cppPointer" );
  delete pFactory;
...
{ QF_STACK_TRY
  ...
  FIX::MSSQLStoreFactory* pFactory
  = ( FIX::MSSQLStoreFactory* ) jobj.getLong( "cppPointer" );
