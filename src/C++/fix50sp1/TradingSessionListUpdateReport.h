#ifndef FIX50_TRADINGSESSIONLISTUPDATEREPORT_H
#define FIX50_TRADINGSESSIONLISTUPDATEREPORT_H
...
namespace FIX50
{
  ...
  public:
    ...
    {
    public:
    NoTradingSessions() : FIX::Group(386,336,FIX::message_order(336,625,207,338,339,325,340,567,341,342,343,344,345,387,58,354,355,1301,1300,1326,0)) {}
