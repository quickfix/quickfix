...
namespace FIX
{
 ...
 const std::string MsgType_TestRequest = "1";
 const std::string MsgType_ResendRequest = "2";
 const std::string MsgType_Reject = "3";
 const std::string MsgType_SequenceReset = "4";
 const std::string MsgType_Logout = "5";
 const std::string MsgType_BusinessMessageReject = "j";
 const std::string MsgType_Advertisement = "7";
 const std::string MsgType_IndicationOfInterest = "6";
 const std::string MsgType_News = "B";
 const std::string MsgType_Email = "C";
 const std::string MsgType_QuoteRequest = "R";
 const std::string MsgType_QuoteResponse = "AJ";
 const std::string MsgType_QuoteRequestReject = "AG";
 const std::string MsgType_RFQRequest = "AH";
 const std::string MsgType_Quote = "S";
 const std::string MsgType_QuoteCancel = "Z";
 const std::string MsgType_QuoteStatusRequest = "a";
 const std::string MsgType_QuoteStatusReport = "AI";
 const std::string MsgType_MassQuote = "i";
 const std::string MsgType_MassQuoteAcknowledgement = "b";
 const std::string MsgType_MarketDataRequest = "V";
 const std::string MsgType_MarketDataSnapshotFullRefresh = "W";
 const std::string MsgType_MarketDataIncrementalRefresh = "X";
 const std::string MsgType_MarketDataRequestReject = "Y";
 const std::string MsgType_SecurityDefinitionRequest = "c";
 const std::string MsgType_SecurityDefinition = "d";
 const std::string MsgType_SecurityTypeRequest = "v";
 const std::string MsgType_SecurityTypes = "w";
 const std::string MsgType_SecurityListRequest = "x";
 const std::string MsgType_SecurityList = "y";
 const std::string MsgType_DerivativeSecurityListRequest = "z";
 const std::string MsgType_DerivativeSecurityList = "AA";
 const std::string MsgType_SecurityStatusRequest = "e";
 const std::string MsgType_SecurityStatus = "f";
 const std::string MsgType_TradingSessionStatusRequest = "g";
 const std::string MsgType_TradingSessionStatus = "h";
 const std::string MsgType_NewOrderSingle = "D";
 const std::string MsgType_ExecutionReport = "8";
 const std::string MsgType_DontKnowTrade = "Q";
 const std::string MsgType_OrderCancelReplaceRequest = "G";
 const std::string MsgType_OrderCancelRequest = "F";
 const std::string MsgType_OrderCancelReject = "9";
 const std::string MsgType_OrderStatusRequest = "H";
 const std::string MsgType_OrderMassCancelRequest = "q";
 const std::string MsgType_OrderMassCancelReport = "r";
 const std::string MsgType_OrderMassStatusRequest = "AF";
 const std::string MsgType_NewOrderCross = "s";
 const std::string MsgType_CrossOrderCancelReplaceRequest = "t";
 const std::string MsgType_CrossOrderCancelRequest = "u";
 const std::string MsgType_NewOrderMultileg = "AB";
 const std::string MsgType_MultilegOrderCancelReplaceRequest = "AC";
 const std::string MsgType_BidRequest = "k";
 const std::string MsgType_BidResponse = "l";
 const std::string MsgType_NewOrderList = "E";
 const std::string MsgType_ListStrikePrice = "m";
 const std::string MsgType_ListStatus = "N";
 const std::string MsgType_ListExecute = "L";
 const std::string MsgType_ListCancelRequest = "K";
 const std::string MsgType_ListStatusRequest = "M";
 const std::string MsgType_AllocationInstruction = "J";
 const std::string MsgType_AllocationInstructionAck = "P";
 const std::string MsgType_AllocationReport = "AS";
 const std::string MsgType_AllocationReportAck = "AS";
 const std::string MsgType_Confirmation = "AK";
 const std::string MsgType_ConfirmationAck = "AU";
 const std::string MsgType_ConfirmationRequest = "BS";
 const std::string MsgType_SettlementInstructions = "T";
 const std::string MsgType_SettlementInstructionRequest = "AV";
 const std::string MsgType_TradeCaptureReportRequest = "AD";
 const std::string MsgType_TradeCaptureReportRequestAck = "AQ";
 const std::string MsgType_TradeCaptureReport = "AE";
 const std::string MsgType_TradeCaptureReportAck = "AR";
 const std::string MsgType_RegistrationInstructions = "o";
 const std::string MsgType_RegistrationInstructionsResponse = "p";
 const std::string MsgType_PositionMaintenanceRequest = "AL";
 const std::string MsgType_PositionMaintenanceReport = "AM";
 const std::string MsgType_RequestForPositions = "AN";
 const std::string MsgType_RequestForPositionsAck = "AO";
 const std::string MsgType_PositionReport = "AO";
 const std::string MsgType_AssignmentReport = "AW";
 const std::string MsgType_CollateralRequest = "AX";
 const std::string MsgType_CollateralAssignment = "AY";
 const std::string MsgType_CollateralResponse = "AZ";
 const std::string MsgType_CollateralReport = "BA";
 const std::string MsgType_CollateralInquiry = "BB";
 const std::string MsgType_CollateralInquiryAck = "BB";
 ...
 const std::string SecurityIDSource_CLEARING_HOUSE_CLEARING_ORGANIZATION = "H";
 const std::string SecurityIDSource_ISDA_FPML_PRODUCT_SPECIFICATION = "I";
 const std::string SecurityIDSource_OPTIONS_PRICE_REPORTING_AUTHORITY = "J";
