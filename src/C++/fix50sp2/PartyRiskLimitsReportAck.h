#ifndef FIX50SP2_PARTYRISKLIMITSREPORTACK_H
#define FIX50SP2_PARTYRISKLIMITSREPORTACK_H
...
namespace FIX50SP2
{
  ...
  class PartyRiskLimitsReportAck : public Message
  {
  public:
    PartyRiskLimitsReportAck() : Message(MsgType()) {}
    PartyRiskLimitsReportAck(const FIX::Message& m) : Message(m) {}
    PartyRiskLimitsReportAck(const Message& m) : Message(m) {}
    PartyRiskLimitsReportAck(const PartyRiskLimitsReportAck&) = default;
    PartyRiskLimitsReportAck(PartyRiskLimitsReportAck&&) = default;
    PartyRiskLimitsReportAck& operator=(const PartyRiskLimitsReportAck&) = default;
    PartyRiskLimitsReportAck& operator=(PartyRiskLimitsReportAck&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("DE"); }

    PartyRiskLimitsReportAck(
      const FIX::RiskLimitReportID& aRiskLimitReportID,
      const FIX::RiskLimitReportStatus& aRiskLimitReportStatus )
    : Message(MsgType())
    {
      set(aRiskLimitReportID);
      set(aRiskLimitReportStatus);
    }

    FIELD_SET(*this, FIX::RiskLimitReportID);
    FIELD_SET(*this, FIX::RiskLimitRequestID);
    FIELD_SET(*this, FIX::RiskLimitReportStatus);
    FIELD_SET(*this, FIX::RiskLimitReportRejectReason);
