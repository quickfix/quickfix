...
namespace FIX50SP2
{
  ...
  public:
    ...
    FIELD_SET(*this, FIX::NoClearingPriceParameters);
    class NoClearingPriceParameters: public FIX::Group
    {
    public:
    NoClearingPriceParameters() : FIX::Group(2580,2581,FIX::message_order(2581,2582,2583,2584,2585,2586,2588,2587,2589,1190,2590,2591,1592,1188,2528,2592,0)) {}
      FIELD_SET(*this, FIX::BusinessDayType);
      FIELD_SET(*this, FIX::ClearingPriceOffset);
      FIELD_SET(*this, FIX::VegaMultiplier);
      FIELD_SET(*this, FIX::AnnualTradingBusinessDays);
      FIELD_SET(*this, FIX::TotalTradingBusinessDays);
      FIELD_SET(*this, FIX::TradingBusinessDays);
      FIELD_SET(*this, FIX::StandardVariance);
      FIELD_SET(*this, FIX::RealizedVariance);
      FIELD_SET(*this, FIX::RelatedClosePrice);
      FIELD_SET(*this, FIX::RiskFreeRate);
      FIELD_SET(*this, FIX::OvernightInterestRate);
      FIELD_SET(*this, FIX::AccumulatedReturnModifiedVariationMargin);
      FIELD_SET(*this, FIX::DiscountFactor);
      FIELD_SET(*this, FIX::Volatility);
      FIELD_SET(*this, FIX::ClearingSettlPrice);
      FIELD_SET(*this, FIX::CalculationMethod);
    };
    ...
    FIELD_SET(*this, FIX::LinkageHandlingIndicator);
