#ifndef FIX50SP2_PARTYDETAILSDEFINITIONREQUEST_H
#define FIX50SP2_PARTYDETAILSDEFINITIONREQUEST_H
...
namespace FIX50SP2
{
  ...
  class PartyDetailsDefinitionRequest : public Message
  {
  public:
    PartyDetailsDefinitionRequest() : Message(MsgType()) {}
    PartyDetailsDefinitionRequest(const FIX::Message& m) : Message(m) {}
    PartyDetailsDefinitionRequest(const Message& m) : Message(m) {}
    PartyDetailsDefinitionRequest(const PartyDetailsDefinitionRequest&) = default;
    PartyDetailsDefinitionRequest(PartyDetailsDefinitionRequest&&) = default;
    PartyDetailsDefinitionRequest& operator=(const PartyDetailsDefinitionRequest&) = default;
    PartyDetailsDefinitionRequest& operator=(PartyDetailsDefinitionRequest&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("CX"); }
