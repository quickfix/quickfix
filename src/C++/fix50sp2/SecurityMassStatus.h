#ifndef FIX50SP2_SECURITYMASSSTATUS_H
#define FIX50SP2_SECURITYMASSSTATUS_H
...
namespace FIX50SP2
{
  ...
  class SecurityMassStatus : public Message
  {
  public:
    SecurityMassStatus() : Message(MsgType()) {}
    SecurityMassStatus(const FIX::Message& m) : Message(m) {}
    SecurityMassStatus(const Message& m) : Message(m) {}
    SecurityMassStatus(const SecurityMassStatus&) = default;
    SecurityMassStatus(SecurityMassStatus&&) = default;
    SecurityMassStatus& operator=(const SecurityMassStatus&) = default;
    SecurityMassStatus& operator=(SecurityMassStatus&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("CO"); }
    ...
    FIELD_SET(*this, FIX::SecurityMassTradingStatus);
    FIELD_SET(*this, FIX::FastMarketIndicator);
    FIELD_SET(*this, FIX::SecurityMassTradingEvent);
    FIELD_SET(*this, FIX::MassHaltReason);
