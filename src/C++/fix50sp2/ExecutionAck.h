#ifndef FIX50SP2_EXECUTIONACK_H
#define FIX50SP2_EXECUTIONACK_H
...
namespace FIX50SP2
{
  ...
  class ExecutionAck : public Message
  {
  public:
    ExecutionAck() : Message(MsgType()) {}
    ExecutionAck(const FIX::Message& m) : Message(m) {}
    ExecutionAck(const Message& m) : Message(m) {}
    ExecutionAck(const ExecutionAck&) = default;
    ExecutionAck(ExecutionAck&&) = default;
    ExecutionAck& operator=(const ExecutionAck&) = default;
    ExecutionAck& operator=(ExecutionAck&&) = default;
