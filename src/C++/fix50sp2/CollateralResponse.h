...
namespace FIX50SP2
{
  ...
  public:
    ...
    FIELD_SET(*this, FIX::CollateralRequestLinkID);
    FIELD_SET(*this, FIX::TotNumCollateralRequests);
    FIELD_SET(*this, FIX::CollateralRequestNumber);
    FIELD_SET(*this, FIX::CollateralRequestInstruction);
    FIELD_SET(*this, FIX::Text);
    FIELD_SET(*this, FIX::EncodedTextLen);
    FIELD_SET(*this, FIX::EncodedText);
    FIELD_SET(*this, FIX::WarningText);
    FIELD_SET(*this, FIX::EncodedWarningTextLen);
    FIELD_SET(*this, FIX::EncodedWarningText);
