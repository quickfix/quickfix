#ifndef FIX50SP2_PAYMANAGEMENTREPORT_H
#define FIX50SP2_PAYMANAGEMENTREPORT_H
...
namespace FIX50SP2
{
  ...
  class PayManagementReport : public Message
  {
  public:
    PayManagementReport() : Message(MsgType()) {}
    PayManagementReport(const FIX::Message& m) : Message(m) {}
    PayManagementReport(const Message& m) : Message(m) {}
    PayManagementReport(const PayManagementReport&) = default;
    PayManagementReport(PayManagementReport&&) = default;
    PayManagementReport& operator=(const PayManagementReport&) = default;
    PayManagementReport& operator=(PayManagementReport&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("EA"); }

    PayManagementReport(
      const FIX::PayReportID& aPayReportID,
      const FIX::PayReportTransType& aPayReportTransType,
      const FIX::TransactTime& aTransactTime )
    : Message(MsgType())
    {
      set(aPayReportID);
      set(aPayReportTransType);
      set(aTransactTime);
    }

    FIELD_SET(*this, FIX::PayReportID);
    FIELD_SET(*this, FIX::PayRequestID);
    FIELD_SET(*this, FIX::PayReportTransType);
    FIELD_SET(*this, FIX::PayReportRefID);
    FIELD_SET(*this, FIX::ReplaceText);
    FIELD_SET(*this, FIX::EncodedReplaceTextLen);
    FIELD_SET(*this, FIX::EncodedReplaceText);
