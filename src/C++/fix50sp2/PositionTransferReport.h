#ifndef FIX50SP2_POSITIONTRANSFERREPORT_H
#define FIX50SP2_POSITIONTRANSFERREPORT_H
...
namespace FIX50SP2
{
  ...
  class PositionTransferReport : public Message
  {
  public:
    PositionTransferReport() : Message(MsgType()) {}
    PositionTransferReport(const FIX::Message& m) : Message(m) {}
    PositionTransferReport(const Message& m) : Message(m) {}
    PositionTransferReport(const PositionTransferReport&) = default;
    PositionTransferReport(PositionTransferReport&&) = default;
    PositionTransferReport& operator=(const PositionTransferReport&) = default;
    PositionTransferReport& operator=(PositionTransferReport&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("DN"); }

    PositionTransferReport(
      const FIX::TransferReportID& aTransferReportID,
      const FIX::TransferID& aTransferID,
      const FIX::TransferTransType& aTransferTransType,
      const FIX::TransferReportType& aTransferReportType,
      const FIX::TransferStatus& aTransferStatus )
    : Message(MsgType())
    {
      set(aTransferReportID);
      set(aTransferID);
      set(aTransferTransType);
      set(aTransferReportType);
      set(aTransferStatus);
    }

    FIELD_SET(*this, FIX::TransferInstructionID);
    FIELD_SET(*this, FIX::TransferReportID);
    FIELD_SET(*this, FIX::TransferID);
    FIELD_SET(*this, FIX::TransferTransType);
    FIELD_SET(*this, FIX::TransferReportType);
