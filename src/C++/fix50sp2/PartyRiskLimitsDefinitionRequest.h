#ifndef FIX50SP2_PARTYRISKLIMITSDEFINITIONREQUEST_H
#define FIX50SP2_PARTYRISKLIMITSDEFINITIONREQUEST_H
...
namespace FIX50SP2
{
  ...
  class PartyRiskLimitsDefinitionRequest : public Message
  {
  public:
    PartyRiskLimitsDefinitionRequest() : Message(MsgType()) {}
    PartyRiskLimitsDefinitionRequest(const FIX::Message& m) : Message(m) {}
    PartyRiskLimitsDefinitionRequest(const Message& m) : Message(m) {}
    PartyRiskLimitsDefinitionRequest(const PartyRiskLimitsDefinitionRequest&) = default;
    PartyRiskLimitsDefinitionRequest(PartyRiskLimitsDefinitionRequest&&) = default;
    PartyRiskLimitsDefinitionRequest& operator=(const PartyRiskLimitsDefinitionRequest&) = default;
    PartyRiskLimitsDefinitionRequest& operator=(PartyRiskLimitsDefinitionRequest&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("CS"); }
