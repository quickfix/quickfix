#ifndef FIX50SP2_MARGINREQUIREMENTINQUIRY_H
#define FIX50SP2_MARGINREQUIREMENTINQUIRY_H
...
namespace FIX50SP2
{
  ...
  class MarginRequirementInquiry : public Message
  {
  public:
    MarginRequirementInquiry() : Message(MsgType()) {}
    MarginRequirementInquiry(const FIX::Message& m) : Message(m) {}
    MarginRequirementInquiry(const Message& m) : Message(m) {}
    MarginRequirementInquiry(const MarginRequirementInquiry&) = default;
    MarginRequirementInquiry(MarginRequirementInquiry&&) = default;
    MarginRequirementInquiry& operator=(const MarginRequirementInquiry&) = default;
    MarginRequirementInquiry& operator=(MarginRequirementInquiry&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("CH"); }
