#ifndef FIX50SP2_PARTYRISKLIMITCHECKREQUEST_H
#define FIX50SP2_PARTYRISKLIMITCHECKREQUEST_H
...
namespace FIX50SP2
{
  ...
  class PartyRiskLimitCheckRequest : public Message
  {
  public:
    PartyRiskLimitCheckRequest() : Message(MsgType()) {}
    PartyRiskLimitCheckRequest(const FIX::Message& m) : Message(m) {}
    PartyRiskLimitCheckRequest(const Message& m) : Message(m) {}
    PartyRiskLimitCheckRequest(const PartyRiskLimitCheckRequest&) = default;
    PartyRiskLimitCheckRequest(PartyRiskLimitCheckRequest&&) = default;
    PartyRiskLimitCheckRequest& operator=(const PartyRiskLimitCheckRequest&) = default;
    PartyRiskLimitCheckRequest& operator=(PartyRiskLimitCheckRequest&&) = default;
    ...
    FIELD_SET(*this, FIX::RiskLimitCheckRequestType);
