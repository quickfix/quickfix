#ifndef FIX50SP2_MASSQUOTEACK_H
#define FIX50SP2_MASSQUOTEACK_H
...
namespace FIX50SP2
{
  ...
  class MassQuoteAck : public Message
  {
  public:
    MassQuoteAck() : Message(MsgType()) {}
    MassQuoteAck(const FIX::Message& m) : Message(m) {}
    MassQuoteAck(const Message& m) : Message(m) {}
    MassQuoteAck(const MassQuoteAck&) = default;
    MassQuoteAck(MassQuoteAck&&) = default;
    MassQuoteAck& operator=(const MassQuoteAck&) = default;
    MassQuoteAck& operator=(MassQuoteAck&&) = default;
