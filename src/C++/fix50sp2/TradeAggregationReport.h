#ifndef FIX50SP2_TRADEAGGREGATIONREPORT_H
#define FIX50SP2_TRADEAGGREGATIONREPORT_H
...
namespace FIX50SP2
{
  ...
  class TradeAggregationReport : public Message
  {
  public:
    TradeAggregationReport() : Message(MsgType()) {}
    TradeAggregationReport(const FIX::Message& m) : Message(m) {}
    TradeAggregationReport(const Message& m) : Message(m) {}
    TradeAggregationReport(const TradeAggregationReport&) = default;
    TradeAggregationReport(TradeAggregationReport&&) = default;
    TradeAggregationReport& operator=(const TradeAggregationReport&) = default;
    TradeAggregationReport& operator=(TradeAggregationReport&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("DX"); }

    TradeAggregationReport(
      const FIX::TradeAggregationReportID& aTradeAggregationReportID,
      const FIX::TradeAggregationRequestStatus& aTradeAggregationRequestStatus )
    : Message(MsgType())
    {
      set(aTradeAggregationReportID);
      set(aTradeAggregationRequestStatus);
    }

    FIELD_SET(*this, FIX::TradeAggregationReportID);
    FIELD_SET(*this, FIX::TradeAggregationRequestID);
    FIELD_SET(*this, FIX::TradeAggregationRequestStatus);
    FIELD_SET(*this, FIX::TradeID);
    FIELD_SET(*this, FIX::TradeAggregationRejectReason);
    FIELD_SET(*this, FIX::AggregatedQty);
    FIELD_SET(*this, FIX::AvgPx);
    FIELD_SET(*this, FIX::AvgSpotRate);
    FIELD_SET(*this, FIX::AvgForwardPoints);
