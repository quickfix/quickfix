...
namespace FIX50SP2
{
  ...
  public:
    ...
    FIELD_SET(*this, FIX::SecurityRejectReason);
    ...
    NoRelatedSym() : FIX::Group(146,55,FIX::message_order(55,65,48,22,460,1227,1151,461,2891,167,762,200,541,1079,966,1049,965,224,1449,1450,1451,1452,1457,1458,1739,2210,1938,1939,1940,2735,1941,1575,1942,1943,1944,1945,1946,1947,1948,1949,1950,2879,1951,1952,1953,1954,1955,1956,1957,1958,1959,1960,1577,1580,1581,1678,1697,225,239,226,227,228,255,543,470,471,472,240,202,2578,2577,947,2904,967,968,1698,1866,2600,2001,2601,1478,1479,1480,1481,206,231,1435,2353,1439,969,1146,996,1147,1716,2905,1191,1192,1717,2906,1193,2579,1194,1482,1195,2753,1196,1197,2002,2140,1524,2907,1198,1199,1200,201,2681,2685,1244,1242,2575,2574,997,223,207,970,971,106,348,349,2737,2714,2715,2716,107,350,351,691,667,875,876,873,874,1687,1787,2141,2142,2143,2752,2144,2145,2576,2962,2602,2603,668,869,2736,2738,1582,913,914,1961,915,918,2952,1962,1963,1964,1965,1966,1967,1968,1969,1970,1513,1525,1527,788,916,917,919,898,1201,711,15,2897,232,555,1647,218,220,2950,221,222,662,663,699,761,235,236,701,696,697,698,1919,1504,1606,58,354,355,0)) {}
      ...
      FIELD_SET(*this, FIX::NoSecurityClassifications);
      class NoSecurityClassifications: public FIX::Group
      {
      public:
      NoSecurityClassifications() : FIX::Group(1582,1583,FIX::message_order(1583,1584,0)) {}
        FIELD_SET(*this, FIX::SecurityClassificationReason);
        FIELD_SET(*this, FIX::SecurityClassificationValue);
      };
      ...
      {
      public:
      NoLegs() : FIX::Group(555,600,FIX::message_order(600,601,602,603,1788,607,1594,608,2893,609,764,610,611,1212,2146,2147,2148,248,2149,2150,2151,2152,2153,2154,2155,2348,2067,2068,2069,2739,2070,2156,2157,2158,2159,2160,2161,2162,2163,2164,2165,2880,2166,2167,2168,2169,2170,2171,2172,2173,2174,2175,2176,2177,2178,2179,2180,249,250,251,252,253,257,599,596,597,598,254,612,942,2908,2181,2182,2183,2184,2604,2185,2605,2186,2187,2188,2189,613,614,1436,2354,1440,2190,2191,999,1224,1720,2909,1421,1422,1721,2910,2192,1001,1420,2193,2194,2755,2195,2196,2197,2198,1528,2911,2199,2200,2201,2202,2203,615,616,2205,2206,617,618,619,2740,2717,2718,2719,620,621,622,2207,2208,623,624,556,2898,740,739,955,956,1358,2682,2686,1017,566,2209,2211,2212,2213,2754,2214,2215,2606,2607,690,587,683,676,2951,677,678,679,680,0)) {}
      ...
      FIELD_SET(*this, FIX::NoPriceMovements);
      class NoPriceMovements: public FIX::Group
      {
      public:
      NoPriceMovements() : FIX::Group(1919,1920,FIX::message_order(1920,1918,0)) {}
        FIELD_SET(*this, FIX::NoPriceMovementValues);
        class NoPriceMovementValues: public FIX::Group
        {
        public:
        NoPriceMovementValues() : FIX::Group(1920,1921,FIX::message_order(1921,1922,1923,0)) {}
          FIELD_SET(*this, FIX::PriceMovementValue);
          FIELD_SET(*this, FIX::PriceMovementPoint);
          FIELD_SET(*this, FIX::PriceMovementType);
        };
        FIELD_SET(*this, FIX::NoClearingAccountTypes);
        class NoClearingAccountTypes: public FIX::Group
        {
        public:
        NoClearingAccountTypes() : FIX::Group(1918,1816,FIX::message_order(1816,0)) {}
          FIELD_SET(*this, FIX::ClearingAccountType);
        };
      };
      FIELD_SET(*this, FIX::RelSymTransactTime);
      FIELD_SET(*this, FIX::NumOfSimpleInstruments);
