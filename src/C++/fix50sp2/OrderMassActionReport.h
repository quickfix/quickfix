...
namespace FIX50SP2
{
  ...
  public:
    ...
    {
    public:
    NoNotAffectedOrders() : FIX::Group(1370,1372,FIX::message_order(1372,1371,1825,2677,0)) {}
      FIELD_SET(*this, FIX::NotAffOrigClOrdID);
      FIELD_SET(*this, FIX::NotAffectedOrderID);
      FIELD_SET(*this, FIX::NotAffSecondaryOrderID);
      FIELD_SET(*this, FIX::NotAffectedReason);
    };
    FIELD_SET(*this, FIX::NoAffectedMarketSegments);
    class NoAffectedMarketSegments: public FIX::Group
    {
    public:
    NoAffectedMarketSegments() : FIX::Group(1791,1792,FIX::message_order(1792,0)) {}
      FIELD_SET(*this, FIX::AffectedMarketSegmentID);
    };
    FIELD_SET(*this, FIX::NoNotAffectedMarketSegments);
    class NoNotAffectedMarketSegments: public FIX::Group
    {
    public:
    NoNotAffectedMarketSegments() : FIX::Group(1793,1794,FIX::message_order(1794,0)) {}
      FIELD_SET(*this, FIX::NotAffectedMarketSegmentID);
    };
    FIELD_SET(*this, FIX::MarketID);
    FIELD_SET(*this, FIX::MarketSegmentID);
    FIELD_SET(*this, FIX::NoTargetMarketSegments);
    class NoTargetMarketSegments: public FIX::Group
    {
    public:
    NoTargetMarketSegments() : FIX::Group(1789,1790,FIX::message_order(1790,0)) {}
      FIELD_SET(*this, FIX::TargetMarketSegmentID);
    };
