#ifndef FIX50SP2_MASSORDERACK_H
#define FIX50SP2_MASSORDERACK_H
...
namespace FIX50SP2
{
  ...
  class MassOrderAck : public Message
  {
  public:
    MassOrderAck() : Message(MsgType()) {}
    MassOrderAck(const FIX::Message& m) : Message(m) {}
    MassOrderAck(const Message& m) : Message(m) {}
    MassOrderAck(const MassOrderAck&) = default;
    MassOrderAck(MassOrderAck&&) = default;
    MassOrderAck& operator=(const MassOrderAck&) = default;
    MassOrderAck& operator=(MassOrderAck&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("DK"); }

    MassOrderAck(
      const FIX::MassOrderRequestStatus& aMassOrderRequestStatus,
      const FIX::TradingCapacity& aTradingCapacity )
    : Message(MsgType())
    {
      set(aMassOrderRequestStatus);
      set(aTradingCapacity);
    }
    ...
    FIELD_SET(*this, FIX::MassOrderReportID);
    FIELD_SET(*this, FIX::MassOrderRequestStatus);
    FIELD_SET(*this, FIX::MassOrderRequestResult);
    FIELD_SET(*this, FIX::OrderResponseLevel);
    ...
    FIELD_SET(*this, FIX::TotNoOrderEntries);
