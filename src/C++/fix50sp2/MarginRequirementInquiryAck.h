#ifndef FIX50SP2_MARGINREQUIREMENTINQUIRYACK_H
#define FIX50SP2_MARGINREQUIREMENTINQUIRYACK_H
...
namespace FIX50SP2
{
  ...
  class MarginRequirementInquiryAck : public Message
  {
  public:
    MarginRequirementInquiryAck() : Message(MsgType()) {}
    MarginRequirementInquiryAck(const FIX::Message& m) : Message(m) {}
    MarginRequirementInquiryAck(const Message& m) : Message(m) {}
    MarginRequirementInquiryAck(const MarginRequirementInquiryAck&) = default;
    MarginRequirementInquiryAck(MarginRequirementInquiryAck&&) = default;
    MarginRequirementInquiryAck& operator=(const MarginRequirementInquiryAck&) = default;
    MarginRequirementInquiryAck& operator=(MarginRequirementInquiryAck&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("CI"); }

    MarginRequirementInquiryAck(
      const FIX::MarginReqmtInqID& aMarginReqmtInqID,
      const FIX::MarginReqmtInqStatus& aMarginReqmtInqStatus )
    : Message(MsgType())
    {
      set(aMarginReqmtInqID);
      set(aMarginReqmtInqStatus);
    }

    FIELD_SET(*this, FIX::MarginReqmtInqID);
    FIELD_SET(*this, FIX::NoMarginReqmtInqQualifier);
    class NoMarginReqmtInqQualifier: public FIX::Group
    {
    public:
    NoMarginReqmtInqQualifier() : FIX::Group(1636,1637,FIX::message_order(1637,0)) {}
      FIELD_SET(*this, FIX::MarginReqmtInqQualifier);
    };
    FIELD_SET(*this, FIX::MarginReqmtInqStatus);
    FIELD_SET(*this, FIX::MarginReqmtInqResult);
