#ifndef FIX50SP2_MARKETDATASTATISTICSREPORT_H
#define FIX50SP2_MARKETDATASTATISTICSREPORT_H
...
namespace FIX50SP2
{
  ...
  class MarketDataStatisticsReport : public Message
  {
  public:
    MarketDataStatisticsReport() : Message(MsgType()) {}
    MarketDataStatisticsReport(const FIX::Message& m) : Message(m) {}
    MarketDataStatisticsReport(const Message& m) : Message(m) {}
    MarketDataStatisticsReport(const MarketDataStatisticsReport&) = default;
    MarketDataStatisticsReport(MarketDataStatisticsReport&&) = default;
    MarketDataStatisticsReport& operator=(const MarketDataStatisticsReport&) = default;
    MarketDataStatisticsReport& operator=(MarketDataStatisticsReport&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("DP"); }

    MarketDataStatisticsReport(
      const FIX::MDStatisticRptID& aMDStatisticRptID )
    : Message(MsgType())
    {
      set(aMDStatisticRptID);
    }
    ...
    FIELD_SET(*this, FIX::MDStatisticRptID);
    FIELD_SET(*this, FIX::MDStatisticReqID);
    FIELD_SET(*this, FIX::MDStatisticRequestResult);
    ...
    FIELD_SET(*this, FIX::NoMDStatistics);
    class NoMDStatistics: public FIX::Group
    {
    public:
    NoMDStatistics() : FIX::Group(2474,2456,FIX::message_order(2456,2457,2458,2459,2454,2455,2481,2482,264,2460,2461,2462,2463,2464,2465,2466,2467,2468,2469,2470,2471,2472,2584,1815,40,59,276,277,54,578,336,625,1024,2711,338,1022,1629,1916,1057,2475,2476,2477,2478,2479,2480,0)) {}
      FIELD_SET(*this, FIX::MDStatisticType);
      FIELD_SET(*this, FIX::MDStatisticScope);
      FIELD_SET(*this, FIX::MDStatisticSubScope);
      FIELD_SET(*this, FIX::MDStatisticScopeType);
      FIELD_SET(*this, FIX::MDStatisticName);
      FIELD_SET(*this, FIX::MDStatisticDesc);
      FIELD_SET(*this, FIX::EncodedMDStatisticDescLen);
      FIELD_SET(*this, FIX::EncodedMDStatisticDesc);
      FIELD_SET(*this, FIX::MarketDepth);
      FIELD_SET(*this, FIX::MDStatisticFrequencyPeriod);
      FIELD_SET(*this, FIX::MDStatisticFrequencyUnit);
      FIELD_SET(*this, FIX::MDStatisticDelayPeriod);
      FIELD_SET(*this, FIX::MDStatisticDelayUnit);
      FIELD_SET(*this, FIX::MDStatisticIntervalType);
      FIELD_SET(*this, FIX::MDStatisticIntervalTypeUnit);
      FIELD_SET(*this, FIX::MDStatisticIntervalPeriod);
      FIELD_SET(*this, FIX::MDStatisticIntervalUnit);
      FIELD_SET(*this, FIX::MDStatisticStartDate);
      FIELD_SET(*this, FIX::MDStatisticEndDate);
      FIELD_SET(*this, FIX::MDStatisticStartTime);
      FIELD_SET(*this, FIX::MDStatisticEndTime);
      FIELD_SET(*this, FIX::MDStatisticRatioType);
      ...
      FIELD_SET(*this, FIX::AnnualTradingBusinessDays);
      ...
      FIELD_SET(*this, FIX::MDValueTier);
      ...
      FIELD_SET(*this, FIX::MDStatisticID);
      FIELD_SET(*this, FIX::MDStatisticTime);
      FIELD_SET(*this, FIX::MDStatisticStatus);
      FIELD_SET(*this, FIX::MDStatisticValue);
      FIELD_SET(*this, FIX::MDStatisticValueType);
      FIELD_SET(*this, FIX::MDStatisticValueUnit);
    };
