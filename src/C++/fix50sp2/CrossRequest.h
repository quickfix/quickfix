#ifndef FIX50SP2_CROSSREQUEST_H
#define FIX50SP2_CROSSREQUEST_H
...
namespace FIX50SP2
{
  ...
  class CrossRequest : public Message
  {
  public:
    CrossRequest() : Message(MsgType()) {}
    CrossRequest(const FIX::Message& m) : Message(m) {}
    CrossRequest(const Message& m) : Message(m) {}
    CrossRequest(const CrossRequest&) = default;
    CrossRequest(CrossRequest&&) = default;
    CrossRequest& operator=(const CrossRequest&) = default;
    CrossRequest& operator=(CrossRequest&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("DS"); }
