#ifndef FIX50SP2_PARTYDETAILSDEFINITIONREQUESTACK_H
#define FIX50SP2_PARTYDETAILSDEFINITIONREQUESTACK_H
...
namespace FIX50SP2
{
  ...
  class PartyDetailsDefinitionRequestAck : public Message
  {
  public:
    PartyDetailsDefinitionRequestAck() : Message(MsgType()) {}
    PartyDetailsDefinitionRequestAck(const FIX::Message& m) : Message(m) {}
    PartyDetailsDefinitionRequestAck(const Message& m) : Message(m) {}
    PartyDetailsDefinitionRequestAck(const PartyDetailsDefinitionRequestAck&) = default;
    PartyDetailsDefinitionRequestAck(PartyDetailsDefinitionRequestAck&&) = default;
    PartyDetailsDefinitionRequestAck& operator=(const PartyDetailsDefinitionRequestAck&) = default;
    PartyDetailsDefinitionRequestAck& operator=(PartyDetailsDefinitionRequestAck&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("CY"); }

    PartyDetailsDefinitionRequestAck(
      const FIX::PartyDetailsListRequestID& aPartyDetailsListRequestID,
      const FIX::PartyDetailRequestStatus& aPartyDetailRequestStatus )
    : Message(MsgType())
    {
      set(aPartyDetailsListRequestID);
      set(aPartyDetailRequestStatus);
    }

    FIELD_SET(*this, FIX::PartyDetailsListRequestID);
    FIELD_SET(*this, FIX::PartyDetailRequestStatus);
    FIELD_SET(*this, FIX::PartyDetailRequestResult);
    ...
    {
    public:
    NoPartyUpdates() : FIX::Group(1676,1324,FIX::message_order(1324,1879,1880,1328,1664,1665,1671,0)) {}
      FIELD_SET(*this, FIX::ListUpdateAction);
      FIELD_SET(*this, FIX::PartyDetailDefinitionStatus);
      FIELD_SET(*this, FIX::PartyDetailDefinitionResult);
