...
namespace FIX50SP2
{
  ...
  public:
    ...
    FIELD_SET(*this, FIX::QuoteModelType);
    FIELD_SET(*this, FIX::PrivateQuote);
    FIELD_SET(*this, FIX::SingleQuoteIndicator);
    ...
    FIELD_SET(*this, FIX::NegotiationMethod);
    ...
    {
    public:
    NoLegs() : FIX::Group(555,600,FIX::message_order(600,601,602,603,1788,607,1594,608,2893,609,764,610,611,1212,2146,2147,2148,248,2149,2150,2151,2152,2153,2154,2155,2348,2067,2068,2069,2739,2070,2156,2157,2158,2159,2160,2161,2162,2163,2164,2165,2880,2166,2167,2168,2169,2170,2171,2172,2173,2174,2175,2176,2177,2178,2179,2180,249,250,251,252,253,257,599,596,597,598,254,612,942,2908,2181,2182,2183,2184,2604,2185,2605,2186,2187,2188,2189,613,614,1436,2354,1440,2190,2191,999,1224,1720,2909,1421,1422,1721,2910,2192,1001,1420,2193,2194,2755,2195,2196,2197,2198,1528,2911,2199,2200,2201,2202,2203,615,616,2205,2206,617,618,619,2740,2717,2718,2719,620,621,622,2207,2208,623,624,556,2898,740,739,955,956,1358,2682,2686,1017,566,2209,2211,2212,2213,2754,2214,2215,2606,2607,685,687,2346,690,587,588,683,539,686,681,684,676,2951,677,678,679,680,654,1067,1068,0)) {}
      ...
      FIELD_SET(*this, FIX::LegBenchmarkCurveCurrencyCodeSource);
    ...
    FIELD_SET(*this, FIX::TotalBidSize);
    FIELD_SET(*this, FIX::MinOfferSize);
    FIELD_SET(*this, FIX::OfferSize);
    FIELD_SET(*this, FIX::TotalOfferSize);
    ...
    FIELD_SET(*this, FIX::BidSpread);
    FIELD_SET(*this, FIX::OfferSpread);
