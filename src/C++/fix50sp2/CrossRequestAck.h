#ifndef FIX50SP2_CROSSREQUESTACK_H
#define FIX50SP2_CROSSREQUESTACK_H
...
namespace FIX50SP2
{
  ...
  class CrossRequestAck : public Message
  {
  public:
    CrossRequestAck() : Message(MsgType()) {}
    CrossRequestAck(const FIX::Message& m) : Message(m) {}
    CrossRequestAck(const Message& m) : Message(m) {}
    CrossRequestAck(const CrossRequestAck&) = default;
    CrossRequestAck(CrossRequestAck&&) = default;
    CrossRequestAck& operator=(const CrossRequestAck&) = default;
    CrossRequestAck& operator=(CrossRequestAck&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("DT"); }

    CrossRequestAck(
      const FIX::CrossRequestID& aCrossRequestID )
    : Message(MsgType())
    {
      set(aCrossRequestID);
    }

    FIELD_SET(*this, FIX::CrossRequestID);
