...
namespace FIX50SP2
{
  ...
  public:
    ...
    FIELD_SET(*this, FIX::WireReference);
    FIELD_SET(*this, FIX::TradeDate);
    FIELD_SET(*this, FIX::TransactionID);
    FIELD_SET(*this, FIX::FirmTransactionID);
    FIELD_SET(*this, FIX::NoFundingSources);
    class NoFundingSources: public FIX::Group
    {
    public:
    NoFundingSources() : FIX::Group(2849,2846,FIX::message_order(2846,2848,2847,2954,0)) {}
      FIELD_SET(*this, FIX::FundingSource);
      FIELD_SET(*this, FIX::FundingSourceMarketValue);
      FIELD_SET(*this, FIX::FundingSourceCurrency);
      FIELD_SET(*this, FIX::FundingSourceCurrencyCodeSource);
    };
