...
namespace FIX50SP2
{
  ...
  public:
    ...
    FIELD_SET(*this, FIX::MassOrderRequestID);
    ...
    {
    public:
    NoAllocs() : FIX::Group(78,79,FIX::message_order(79,661,736,2927,467,2727,539,209,80,1752,1753,1754,1755,0)) {}
    ...
    FIELD_SET(*this, FIX::ShortSaleExemptionReason);
    ...
    FIELD_SET(*this, FIX::TriggerScope);
    ...
    FIELD_SET(*this, FIX::AuctionInstruction);
    ...
    FIELD_SET(*this, FIX::ReportingPx);
    FIELD_SET(*this, FIX::ReportingQty);
    ...
    {
    public:
    NoFills() : FIX::Group(1362,1363,FIX::message_order(1363,1364,1365,2673,2674,1443,1622,1623,1414,0)) {}
      FIELD_SET(*this, FIX::FillExecID);
      FIELD_SET(*this, FIX::FillPx);
      FIELD_SET(*this, FIX::FillQty);
      FIELD_SET(*this, FIX::FillMatchID);
      FIELD_SET(*this, FIX::FillMatchSubID);
      FIELD_SET(*this, FIX::FillLiquidityInd);
      FIELD_SET(*this, FIX::FillYieldType);
      FIELD_SET(*this, FIX::FillYield);
      FIELD_SET(*this, FIX::NoNested4PartyIDs);
      class NoNested4PartyIDs: public FIX::Group
      {
      public:
      NoNested4PartyIDs() : FIX::Group(1414,1415,FIX::message_order(1415,1416,1417,2383,1413,0)) {}
        FIELD_SET(*this, FIX::Nested4PartyID);
        FIELD_SET(*this, FIX::Nested4PartyIDSource);
        FIELD_SET(*this, FIX::Nested4PartyRole);
        FIELD_SET(*this, FIX::Nested4PartyRoleQualifier);
    ...
    FIELD_SET(*this, FIX::NoOrderEvents);
    class NoOrderEvents: public FIX::Group
    {
    public:
    NoOrderEvents() : FIX::Group(1795,1796,FIX::message_order(1796,1797,1798,1799,1800,1801,1802,0)) {}
      FIELD_SET(*this, FIX::OrderEventType);
      FIELD_SET(*this, FIX::OrderEventExecID);
      FIELD_SET(*this, FIX::OrderEventReason);
      FIELD_SET(*this, FIX::OrderEventPx);
      FIELD_SET(*this, FIX::OrderEventQty);
      FIELD_SET(*this, FIX::OrderEventLiquidityIndicator);
      FIELD_SET(*this, FIX::OrderEventText);
    };
    FIELD_SET(*this, FIX::EventInitiatorType);
    ...
    FIELD_SET(*this, FIX::NoRelativeValues);
    class NoRelativeValues: public FIX::Group
    {
    public:
    NoRelativeValues() : FIX::Group(2529,2530,FIX::message_order(2530,2531,2532,0)) {}
      FIELD_SET(*this, FIX::RelativeValueType);
      FIELD_SET(*this, FIX::RelativeValue);
      FIELD_SET(*this, FIX::RelativeValueSide);
    };
    ...
    FIELD_SET(*this, FIX::OffshoreIndicator);
    ...
    FIELD_SET(*this, FIX::MinQtyMethod);
    FIELD_SET(*this, FIX::MatchIncrement);
    FIELD_SET(*this, FIX::MaxPriceLevels);
    FIELD_SET(*this, FIX::MaximumPriceDeviation);
    FIELD_SET(*this, FIX::NoValueChecks);
    class NoValueChecks: public FIX::Group
    {
    public:
    NoValueChecks() : FIX::Group(1868,1869,FIX::message_order(1869,1870,0)) {}
      FIELD_SET(*this, FIX::ValueCheckType);
      FIELD_SET(*this, FIX::ValueCheckAction);
    };
    ...
    FIELD_SET(*this, FIX::CrossedIndicator);
    ...
    FIELD_SET(*this, FIX::NoDisclosureInstructions);
    class NoDisclosureInstructions: public FIX::Group
    {
    public:
    NoDisclosureInstructions() : FIX::Group(1812,1813,FIX::message_order(1813,1814,0)) {}
      FIELD_SET(*this, FIX::DisclosureType);
      FIELD_SET(*this, FIX::DisclosureInstruction);
    };
    FIELD_SET(*this, FIX::MaxFloor);
    FIELD_SET(*this, FIX::ClearingAccountType);
    ...
    {
    public:
    NoLegs() : FIX::Group(555,600,FIX::message_order(600,601,602,603,1788,607,1594,608,2893,609,764,610,611,1212,2146,2147,2148,248,2149,2150,2151,2152,2153,2154,2155,2348,2067,2068,2069,2739,2070,2156,2157,2158,2159,2160,2161,2162,2163,2164,2165,2880,2166,2167,2168,2169,2170,2171,2172,2173,2174,2175,2176,2177,2178,2179,2180,249,250,251,252,253,257,599,596,597,598,254,612,942,2908,2181,2182,2183,2184,2604,2185,2605,2186,2187,2188,2189,613,614,1436,2354,1440,2190,2191,999,1224,1720,2909,1421,1422,1721,2910,2192,1001,1420,2193,2194,2755,2195,2196,2197,2198,1528,2911,2199,2200,2201,2202,2203,615,616,2205,2206,617,618,619,2740,2717,2718,2719,620,621,622,2207,2208,623,624,556,2898,740,739,955,956,1358,2682,2686,1017,566,2209,2211,2212,2213,2754,2214,2215,2606,2607,685,687,2346,690,683,1366,670,2680,1817,564,565,948,654,587,588,637,675,2900,1073,1074,1075,1689,1379,1381,1383,1384,1418,2421,0)) {}
      ...
      {
      public:
      NoLegAllocs() : FIX::Group(670,671,FIX::message_order(671,672,756,673,674,1367,2928,1756,1757,1758,1759,0)) {}
        ...
        FIELD_SET(*this, FIX::LegAllocSettlCurrencyCodeSource);
        FIELD_SET(*this, FIX::LegCustodialLotID);
        FIELD_SET(*this, FIX::LegVersusPurchaseDate);
        FIELD_SET(*this, FIX::LegVersusPurchasePrice);
        FIELD_SET(*this, FIX::LegCurrentCostBasis);
      };
      ...
      {
      public:
      NoNested3PartyIDs() : FIX::Group(948,949,FIX::message_order(949,950,951,2382,952,0)) {}
        FIELD_SET(*this, FIX::Nested3PartyID);
        FIELD_SET(*this, FIX::Nested3PartyIDSource);
        FIELD_SET(*this, FIX::Nested3PartyRole);
        FIELD_SET(*this, FIX::Nested3PartyRoleQualifier);
    ...
    FIELD_SET(*this, FIX::ContraOrderOrigination);
    FIELD_SET(*this, FIX::OriginatingDeptID);
    FIELD_SET(*this, FIX::ReceivingDeptID);
    FIELD_SET(*this, FIX::RoutingArrangmentIndicator);
    FIELD_SET(*this, FIX::ContraRoutingArrangmentIndicator);
    FIELD_SET(*this, FIX::AffiliatedFirmsTradeIndicator);
    FIELD_SET(*this, FIX::OwnerType);
    FIELD_SET(*this, FIX::OrderOwnershipIndicator);
    ...
    FIELD_SET(*this, FIX::CoverPrice);
    FIELD_SET(*this, FIX::ThrottleInst);
    FIELD_SET(*this, FIX::ThrottleStatus);
    FIELD_SET(*this, FIX::ThrottleCountIndicator);
    FIELD_SET(*this, FIX::RefOrderID);
    FIELD_SET(*this, FIX::RefOrderIDSource);
    FIELD_SET(*this, FIX::RefClOrdID);
    ...
    FIELD_SET(*this, FIX::AuctionAllocationPct);
    FIELD_SET(*this, FIX::LockedQty);
    FIELD_SET(*this, FIX::SecondaryLockedQty);
    FIELD_SET(*this, FIX::LockType);
    FIELD_SET(*this, FIX::ReleaseInstruction);
    FIELD_SET(*this, FIX::ReleaseQty);
    FIELD_SET(*this, FIX::RelatedHighPrice);
    FIELD_SET(*this, FIX::RelatedLowPrice);
    FIELD_SET(*this, FIX::RelatedPriceSource);
  };
