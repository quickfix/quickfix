#ifndef FIX50SP2_PARTYRISKLIMITCHECKREQUESTACK_H
#define FIX50SP2_PARTYRISKLIMITCHECKREQUESTACK_H
...
namespace FIX50SP2
{
  ...
  class PartyRiskLimitCheckRequestAck : public Message
  {
  public:
    PartyRiskLimitCheckRequestAck() : Message(MsgType()) {}
    PartyRiskLimitCheckRequestAck(const FIX::Message& m) : Message(m) {}
    PartyRiskLimitCheckRequestAck(const Message& m) : Message(m) {}
    PartyRiskLimitCheckRequestAck(const PartyRiskLimitCheckRequestAck&) = default;
    PartyRiskLimitCheckRequestAck(PartyRiskLimitCheckRequestAck&&) = default;
    PartyRiskLimitCheckRequestAck& operator=(const PartyRiskLimitCheckRequestAck&) = default;
    PartyRiskLimitCheckRequestAck& operator=(PartyRiskLimitCheckRequestAck&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("DG"); }

    PartyRiskLimitCheckRequestAck(
      const FIX::RiskLimitCheckRequestStatus& aRiskLimitCheckRequestStatus,
      const FIX::RiskLimitCheckTransType& aRiskLimitCheckTransType,
      const FIX::RiskLimitCheckType& aRiskLimitCheckType )
    : Message(MsgType())
    {
      set(aRiskLimitCheckRequestStatus);
      set(aRiskLimitCheckTransType);
      set(aRiskLimitCheckType);
    }

    FIELD_SET(*this, FIX::RiskLimitCheckRequestID);
    FIELD_SET(*this, FIX::RiskLimitCheckID);
    FIELD_SET(*this, FIX::RiskLimitCheckRequestStatus);
    FIELD_SET(*this, FIX::RiskLimitCheckRequestResult);
    FIELD_SET(*this, FIX::RiskLimitCheckTransType);
    FIELD_SET(*this, FIX::RiskLimitCheckType);
    FIELD_SET(*this, FIX::RiskLimitCheckRequestRefID);
    ...
    FIELD_SET(*this, FIX::RiskLimitApprovedAmount);
    FIELD_SET(*this, FIX::RiskLimitCheckAmount);
