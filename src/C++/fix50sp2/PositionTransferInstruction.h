#ifndef FIX50SP2_POSITIONTRANSFERINSTRUCTION_H
#define FIX50SP2_POSITIONTRANSFERINSTRUCTION_H
...
namespace FIX50SP2
{
  ...
  class PositionTransferInstruction : public Message
  {
  public:
    PositionTransferInstruction() : Message(MsgType()) {}
    PositionTransferInstruction(const FIX::Message& m) : Message(m) {}
    PositionTransferInstruction(const Message& m) : Message(m) {}
    PositionTransferInstruction(const PositionTransferInstruction&) = default;
    PositionTransferInstruction(PositionTransferInstruction&&) = default;
    PositionTransferInstruction& operator=(const PositionTransferInstruction&) = default;
    PositionTransferInstruction& operator=(PositionTransferInstruction&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("DL"); }
