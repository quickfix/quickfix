...
namespace FIX50SP2
{
  ...
  public:
    ...
    FIELD_SET(*this, FIX::AllocReversalStatus);
    ...
    {
    public:
    NoExecs() : FIX::Group(124,32,FIX::message_order(32,17,527,31,669,29,1003,1041,880,2749,2524,2668,1838,0)) {}
      ...
      FIELD_SET(*this, FIX::ExecutionTimestamp);
    ...
    FIELD_SET(*this, FIX::AllocGroupQuantity);
    FIELD_SET(*this, FIX::AllocGroupRemainingQuantity);
    ...
    {
    public:
    NoAllocs() : FIX::Group(78,79,FIX::message_order(79,661,573,366,80,2515,1752,1753,1754,1755,467,1729,1593,2727,1908,81,989,1002,1735,993,1047,992,539,208,209,161,360,361,1732,1733,1734,12,13,479,2922,1233,1238,497,2653,153,154,119,2300,737,120,736,2927,155,156,742,741,136,576,635,780,172,169,170,171,2392,2393,2483,2761,2770,2769,1844,0)) {}
      ...
      FIELD_SET(*this, FIX::AllocGrossTradeAmt);
      ...
      FIELD_SET(*this, FIX::AllocRiskLimitCheckStatus);
      FIELD_SET(*this, FIX::AllocGroupAmount);
