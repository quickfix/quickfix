...
namespace FIX50SP2
{
  ...
  public:
    ...
    FIELD_SET(*this, FIX::PositionID);
    FIELD_SET(*this, FIX::PosReqID);
    FIELD_SET(*this, FIX::PosReqType);
    FIELD_SET(*this, FIX::PosReportAction);
    FIELD_SET(*this, FIX::MarginReqmtInqID);
    ...
    FIELD_SET(*this, FIX::PreviousClearingBusinessDate);
    ...
    FIELD_SET(*this, FIX::ContractRefPosType);
    FIELD_SET(*this, FIX::PositionCapacity);
    FIELD_SET(*this, FIX::TerminatedIndicator);
    ...
    FIELD_SET(*this, FIX::SettlForwardPoints);
    FIELD_SET(*this, FIX::SettlPriceUnitOfMeasure);
    FIELD_SET(*this, FIX::SettlPriceUnitOfMeasureCurrency);
    FIELD_SET(*this, FIX::SettlPriceUnitOfMeasureCurrencyCodeSource);
    FIELD_SET(*this, FIX::SettlPriceType);
    FIELD_SET(*this, FIX::PriorSettlPrice);
    FIELD_SET(*this, FIX::PositionContingentPrice);
    ...
    {
    public:
    NoPositions() : FIX::Group(702,703,FIX::message_order(703,704,705,1654,706,976,1836,1835,2936,539,0)) {}
      ...
      FIELD_SET(*this, FIX::PosQtyUnitOfMeasure);
      FIELD_SET(*this, FIX::PosQtyUnitOfMeasureCurrency);
      FIELD_SET(*this, FIX::PosQtyUnitOfMeasureCurrencyCodeSource);
