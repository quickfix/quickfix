#ifndef FIX50SP2_PAYMANAGEMENTREQUEST_H
#define FIX50SP2_PAYMANAGEMENTREQUEST_H
...
namespace FIX50SP2
{
  ...
  class PayManagementRequest : public Message
  {
  public:
    PayManagementRequest() : Message(MsgType()) {}
    PayManagementRequest(const FIX::Message& m) : Message(m) {}
    PayManagementRequest(const Message& m) : Message(m) {}
    PayManagementRequest(const PayManagementRequest&) = default;
    PayManagementRequest(PayManagementRequest&&) = default;
    PayManagementRequest& operator=(const PayManagementRequest&) = default;
    PayManagementRequest& operator=(PayManagementRequest&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("DY"); }

    PayManagementRequest(
      const FIX::PayRequestID& aPayRequestID,
      const FIX::PayRequestTransType& aPayRequestTransType,
      const FIX::TransactTime& aTransactTime )
    : Message(MsgType())
    {
      set(aPayRequestID);
      set(aPayRequestTransType);
      set(aTransactTime);
    }

    FIELD_SET(*this, FIX::PayRequestID);
    FIELD_SET(*this, FIX::PayRequestTransType);
    FIELD_SET(*this, FIX::PayRequestRefID);
    FIELD_SET(*this, FIX::CancelText);
    FIELD_SET(*this, FIX::EncodedCancelTextLen);
    FIELD_SET(*this, FIX::EncodedCancelText);
    ...
    FIELD_SET(*this, FIX::PostTradePaymentType);
    FIELD_SET(*this, FIX::PostTradePaymentAmount);
    FIELD_SET(*this, FIX::PostTradePaymentCurrency);
    FIELD_SET(*this, FIX::PostTradePaymentCurrencyCodeSource);
    FIELD_SET(*this, FIX::PostTradePaymentCalculationDate);
    FIELD_SET(*this, FIX::PostTradePaymentValueDate);
    FIELD_SET(*this, FIX::PostTradePaymentFinalValueDate);
    FIELD_SET(*this, FIX::PostTradePaymentDebitOrCredit);
    FIELD_SET(*this, FIX::PostTradePaymentAccount);
    FIELD_SET(*this, FIX::PostTradePaymentID);
    FIELD_SET(*this, FIX::PostTradePaymentDesc);
    FIELD_SET(*this, FIX::EncodedPostTradePaymentDescLen);
    FIELD_SET(*this, FIX::EncodedPostTradePaymentDesc);
    FIELD_SET(*this, FIX::PostTradePaymentLinkID);
    FIELD_SET(*this, FIX::PostTradePaymentStatus);
