#ifndef FIX50SP2_PARTYENTITLEMENTSUPDATEREPORT_H
#define FIX50SP2_PARTYENTITLEMENTSUPDATEREPORT_H
...
namespace FIX50SP2
{
  ...
  class PartyEntitlementsUpdateReport : public Message
  {
  public:
    PartyEntitlementsUpdateReport() : Message(MsgType()) {}
    PartyEntitlementsUpdateReport(const FIX::Message& m) : Message(m) {}
    PartyEntitlementsUpdateReport(const Message& m) : Message(m) {}
    PartyEntitlementsUpdateReport(const PartyEntitlementsUpdateReport&) = default;
    PartyEntitlementsUpdateReport(PartyEntitlementsUpdateReport&&) = default;
    PartyEntitlementsUpdateReport& operator=(const PartyEntitlementsUpdateReport&) = default;
    PartyEntitlementsUpdateReport& operator=(PartyEntitlementsUpdateReport&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("CZ"); }
