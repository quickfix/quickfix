#ifndef FIX50SP2_PARTYRISKLIMITSREPORT_H
#define FIX50SP2_PARTYRISKLIMITSREPORT_H
...
namespace FIX50SP2
{
  ...
  class PartyRiskLimitsReport : public Message
  {
  public:
    PartyRiskLimitsReport() : Message(MsgType()) {}
    PartyRiskLimitsReport(const FIX::Message& m) : Message(m) {}
    PartyRiskLimitsReport(const Message& m) : Message(m) {}
    PartyRiskLimitsReport(const PartyRiskLimitsReport&) = default;
    PartyRiskLimitsReport(PartyRiskLimitsReport&&) = default;
    PartyRiskLimitsReport& operator=(const PartyRiskLimitsReport&) = default;
    PartyRiskLimitsReport& operator=(PartyRiskLimitsReport&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("CM"); }
    ...
    {
    public:
    NoPartyRiskLimits() : FIX::Group(1677,1671,FIX::message_order(1671,1669,1670,2339,2355,0)) {}
