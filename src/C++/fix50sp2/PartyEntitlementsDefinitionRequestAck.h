#ifndef FIX50SP2_PARTYENTITLEMENTSDEFINITIONREQUESTACK_H
#define FIX50SP2_PARTYENTITLEMENTSDEFINITIONREQUESTACK_H
...
namespace FIX50SP2
{
  ...
  class PartyEntitlementsDefinitionRequestAck : public Message
  {
  public:
    PartyEntitlementsDefinitionRequestAck() : Message(MsgType()) {}
    PartyEntitlementsDefinitionRequestAck(const FIX::Message& m) : Message(m) {}
    PartyEntitlementsDefinitionRequestAck(const Message& m) : Message(m) {}
    PartyEntitlementsDefinitionRequestAck(const PartyEntitlementsDefinitionRequestAck&) = default;
    PartyEntitlementsDefinitionRequestAck(PartyEntitlementsDefinitionRequestAck&&) = default;
    PartyEntitlementsDefinitionRequestAck& operator=(const PartyEntitlementsDefinitionRequestAck&) = default;
    PartyEntitlementsDefinitionRequestAck& operator=(PartyEntitlementsDefinitionRequestAck&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("DB"); }

    PartyEntitlementsDefinitionRequestAck(
      const FIX::EntitlementRequestID& aEntitlementRequestID,
      const FIX::EntitlementRequestStatus& aEntitlementRequestStatus )
    : Message(MsgType())
    {
      set(aEntitlementRequestID);
      set(aEntitlementRequestStatus);
    }

    FIELD_SET(*this, FIX::EntitlementRequestID);
    FIELD_SET(*this, FIX::EntitlementRequestStatus);
    FIELD_SET(*this, FIX::EntitlementRequestResult);
    ...
    {
    public:
    NoPartyEntitlements() : FIX::Group(1772,1324,FIX::message_order(1324,1883,1884,1328,1664,1665,1671,1773,1885,0)) {}
      FIELD_SET(*this, FIX::ListUpdateAction);
      FIELD_SET(*this, FIX::EntitlementStatus);
      FIELD_SET(*this, FIX::EntitlementResult);
      ...
      FIELD_SET(*this, FIX::EntitlementRefID);
    };
