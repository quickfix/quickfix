...
namespace FIX50SP2
{
  ...
  public:
    ...
    FIELD_SET(*this, FIX::PackageID);
    FIELD_SET(*this, FIX::TradeNumber);
    ...
    FIELD_SET(*this, FIX::OffsetInstruction);
    ...
    FIELD_SET(*this, FIX::RegulatoryTransactionType);
    ...
    {
    public:
    NoRootPartyIDs() : FIX::Group(1116,1117,FIX::message_order(1117,1118,1119,2388,1120,0)) {}
      FIELD_SET(*this, FIX::RootPartyID);
      FIELD_SET(*this, FIX::RootPartyIDSource);
      FIELD_SET(*this, FIX::RootPartyRole);
      FIELD_SET(*this, FIX::RootPartyRoleQualifier);
    ...
    FIELD_SET(*this, FIX::TaxonomyType);
    ...
    FIELD_SET(*this, FIX::NoPayments);
    class NoPayments: public FIX::Group
    {
    public:
    NoPayments() : FIX::Group(40212,40213,FIX::message_order(40213,40993,40214,40215,43087,40216,40217,42598,42599,43097,43098,43100,43099,43101,43105,43104,43103,43102,40218,40919,41155,40219,40220,40944,41156,41157,41158,41159,40222,41160,40224,40225,40226,40227,492,40230,41304,40229,40984,40985,0)) {}
      FIELD_SET(*this, FIX::PaymentType);
      FIELD_SET(*this, FIX::PaymentSubType);
      FIELD_SET(*this, FIX::PaymentPaySide);
      FIELD_SET(*this, FIX::PaymentReceiveSide);
      FIELD_SET(*this, FIX::PaymentDesc);
      FIELD_SET(*this, FIX::PaymentCurrency);
      FIELD_SET(*this, FIX::PaymentAmount);
      FIELD_SET(*this, FIX::PaymentAmountRelativeTo);
      FIELD_SET(*this, FIX::PaymentAmountDeterminationMethod);
      FIELD_SET(*this, FIX::PaymentFixedRate);
      FIELD_SET(*this, FIX::PaymentFloatingRateIndex);
      FIELD_SET(*this, FIX::PaymentFloatingRateIndexCurveUnit);
      FIELD_SET(*this, FIX::PaymentFloatingRateIndexCurvePeriod);
      FIELD_SET(*this, FIX::PaymentFloatingRateSpread);
      FIELD_SET(*this, FIX::PaymentRateResetFrequencyUnit);
      FIELD_SET(*this, FIX::PaymentRateResetFrequencyPeriod);
      FIELD_SET(*this, FIX::PaymentFrequencyUnit);
      FIELD_SET(*this, FIX::PaymentFrequencyPeriod);
      FIELD_SET(*this, FIX::PaymentPrice);
      FIELD_SET(*this, FIX::PaymentPriceType);
      FIELD_SET(*this, FIX::PaymentUnitOfMeasure);
      FIELD_SET(*this, FIX::PaymentDateUnadjusted);
      FIELD_SET(*this, FIX::PaymentBusinessDayConvention);
      FIELD_SET(*this, FIX::NoPaymentBusinessCenters);
      class NoPaymentBusinessCenters: public FIX::Group
      {
      public:
      NoPaymentBusinessCenters() : FIX::Group(40944,40221,FIX::message_order(40221,0)) {}
        FIELD_SET(*this, FIX::PaymentBusinessCenter);
      };
      FIELD_SET(*this, FIX::PaymentDateRelativeTo);
      FIELD_SET(*this, FIX::PaymentDateOffsetPeriod);
      FIELD_SET(*this, FIX::PaymentDateOffsetUnit);
      FIELD_SET(*this, FIX::PaymentDateOffsetDayType);
      FIELD_SET(*this, FIX::PaymentDateAdjusted);
      FIELD_SET(*this, FIX::PaymentForwardStartType);
      FIELD_SET(*this, FIX::PaymentDiscountFactor);
      FIELD_SET(*this, FIX::PaymentPresentValueAmount);
      FIELD_SET(*this, FIX::PaymentPresentValueCurrency);
      FIELD_SET(*this, FIX::PaymentSettlStyle);
      FIELD_SET(*this, FIX::PaymentMethod);
      FIELD_SET(*this, FIX::NoPaymentSettls);
      class NoPaymentSettls: public FIX::Group
      {
      public:
      NoPaymentSettls() : FIX::Group(40230,40231,FIX::message_order(40231,40232,40233,0)) {}
        FIELD_SET(*this, FIX::PaymentSettlAmount);
        FIELD_SET(*this, FIX::PaymentSettlCurrency);
        FIELD_SET(*this, FIX::NoPaymentSettlPartyIDs);
        class NoPaymentSettlPartyIDs: public FIX::Group
        {
        public:
        NoPaymentSettlPartyIDs() : FIX::Group(40233,40234,FIX::message_order(40234,40235,40236,40237,40238,0)) {}
          FIELD_SET(*this, FIX::PaymentSettlPartyID);
          FIELD_SET(*this, FIX::PaymentSettlPartyIDSource);
          FIELD_SET(*this, FIX::PaymentSettlPartyRole);
          FIELD_SET(*this, FIX::PaymentSettlPartyRoleQualifier);
          FIELD_SET(*this, FIX::NoPaymentSettlPartySubIDs);
          class NoPaymentSettlPartySubIDs: public FIX::Group
          {
          public:
          NoPaymentSettlPartySubIDs() : FIX::Group(40238,40239,FIX::message_order(40239,40240,0)) {}
            FIELD_SET(*this, FIX::PaymentSettlPartySubID);
            FIELD_SET(*this, FIX::PaymentSettlPartySubIDType);
          };
        };
      };
      FIELD_SET(*this, FIX::PaymentLegRefID);
      FIELD_SET(*this, FIX::PaymentText);
      FIELD_SET(*this, FIX::EncodedPaymentTextLen);
      FIELD_SET(*this, FIX::EncodedPaymentText);
    };
    ...
    FIELD_SET(*this, FIX::CollateralizationValueDate);
    ...
    FIELD_SET(*this, FIX::NoTransactionAttributes);
    class NoTransactionAttributes: public FIX::Group
    {
    public:
    NoTransactionAttributes() : FIX::Group(2871,2872,FIX::message_order(2872,2873,0)) {}
      FIELD_SET(*this, FIX::TransactionAttributeType);
      FIELD_SET(*this, FIX::TransactionAttributeValue);
    };
    FIELD_SET(*this, FIX::UnderlyingTradingSessionID);
    FIELD_SET(*this, FIX::UnderlyingTradingSessionSubID);
    FIELD_SET(*this, FIX::LastQty);
    FIELD_SET(*this, FIX::LastQtyVariance);
    FIELD_SET(*this, FIX::LastQtyChanged);
    FIELD_SET(*this, FIX::LastMultipliedQty);
    FIELD_SET(*this, FIX::TotalTradeQty);
    FIELD_SET(*this, FIX::TotalTradeMultipliedQty);
    FIELD_SET(*this, FIX::LastPx);
    FIELD_SET(*this, FIX::MidPx);
    FIELD_SET(*this, FIX::DifferentialPrice);
    FIELD_SET(*this, FIX::CalculatedCcyLastQty);
    FIELD_SET(*this, FIX::PriceMarkup);
    FIELD_SET(*this, FIX::AveragePriceType);
    FIELD_SET(*this, FIX::AveragePriceStartTime);
    FIELD_SET(*this, FIX::AveragePriceEndTime);
    FIELD_SET(*this, FIX::Currency);
    FIELD_SET(*this, FIX::CurrencyCodeSource);
    FIELD_SET(*this, FIX::SettlCurrency);
    FIELD_SET(*this, FIX::SettlCurrencyCodeSource);
    FIELD_SET(*this, FIX::SettlPriceFxRateCalc);
    ...
    FIELD_SET(*this, FIX::PricePrecision);
    FIELD_SET(*this, FIX::LastMkt);
    FIELD_SET(*this, FIX::ClearingTradePrice);
    FIELD_SET(*this, FIX::TradePriceNegotiationMethod);
    FIELD_SET(*this, FIX::LastUpfrontPrice);
    FIELD_SET(*this, FIX::UpfrontPriceType);
    FIELD_SET(*this, FIX::TradeDate);
    FIELD_SET(*this, FIX::ClearingBusinessDate);
    FIELD_SET(*this, FIX::ClearingPortfolioID);
    ...
    FIELD_SET(*this, FIX::ValuationDate);
    FIELD_SET(*this, FIX::ValuationTime);
    FIELD_SET(*this, FIX::ValuationBusinessCenter);
    ...
    NoLegs() : FIX::Group(555,600,FIX::message_order(600,601,602,603,1788,607,1594,608,2893,609,764,610,611,1212,2146,2147,2148,248,2149,2150,2151,2152,2153,2154,2155,2348,2067,2068,2069,2739,2070,2156,2157,2158,2159,2160,2161,2162,2163,2164,2165,2880,2166,2167,2168,2169,2170,2171,2172,2173,2174,2175,2176,2177,2178,2179,2180,249,250,251,252,253,257,599,596,597,598,254,612,942,2908,2181,2182,2183,2184,2604,2185,2605,2186,2187,2188,2189,613,614,1436,2354,1440,2190,2191,999,1224,1720,2909,1421,1422,1721,2910,2192,1001,1420,2193,2194,2755,2195,2196,2197,2198,1528,2911,2199,2200,2201,2202,2203,615,616,2205,2206,617,618,619,2740,2717,2718,2719,620,621,622,2207,2208,623,624,556,2898,740,739,955,956,1358,2682,2686,1017,566,2209,2211,2212,2213,2754,2214,2215,2606,2607,2497,2498,2499,2496,2495,2953,2511,2510,2512,2509,2500,2502,2501,2503,2507,2505,2494,2493,2514,2513,2506,2504,2508,1586,685,687,2346,690,990,1152,683,2680,1817,564,565,539,654,587,588,637,686,675,2900,1073,1074,1075,1689,1379,1381,1383,1384,1418,1591,2358,2357,2360,2359,1342,2492,0)) {}
      ...
      FIELD_SET(*this, FIX::NoLegPosAmt);
      class NoLegPosAmt: public FIX::Group
      {
      public:
      NoLegPosAmt() : FIX::Group(1586,1587,FIX::message_order(1587,1588,1589,2938,1590,0)) {}
        FIELD_SET(*this, FIX::LegPosAmt);
        FIELD_SET(*this, FIX::LegPosAmtType);
        FIELD_SET(*this, FIX::LegPosCurrency);
        FIELD_SET(*this, FIX::LegPosCurrencyCodeSource);
        FIELD_SET(*this, FIX::LegPosAmtReason);
      };
      FIELD_SET(*this, FIX::LegOrderQty);
      FIELD_SET(*this, FIX::LegQty);
      FIELD_SET(*this, FIX::LegMidPx);
      ...
      FIELD_SET(*this, FIX::LegAccount);
      FIELD_SET(*this, FIX::LegClearingAccountType);
      ...
      FIELD_SET(*this, FIX::LegQtyType);
      FIELD_SET(*this, FIX::LegLastMultipliedQty);
      FIELD_SET(*this, FIX::LegTotalTradeQty);
      FIELD_SET(*this, FIX::LegTotalTradeMultipliedQty);
      FIELD_SET(*this, FIX::LegTotalGrossTradeAmt);
      ...
      FIELD_SET(*this, FIX::LegDifferentialPrice);
    };
    ...
    {
    public:
    NoTrdRegTimestamps() : FIX::Group(768,769,FIX::message_order(769,770,771,2839,1033,1034,1035,1727,2831,2832,2833,2834,0)) {}
      FIELD_SET(*this, FIX::TrdRegTimestamp);
      FIELD_SET(*this, FIX::TrdRegTimestampType);
      FIELD_SET(*this, FIX::TrdRegTimestampOrigin);
      FIELD_SET(*this, FIX::TrdRegTimestampManualIndicator);
      FIELD_SET(*this, FIX::DeskType);
      FIELD_SET(*this, FIX::DeskTypeSource);
      FIELD_SET(*this, FIX::DeskOrderHandlingInst);
      FIELD_SET(*this, FIX::InformationBarrierID);
      FIELD_SET(*this, FIX::NBBOEntryType);
      FIELD_SET(*this, FIX::NBBOPrice);
      FIELD_SET(*this, FIX::NBBOQty);
      FIELD_SET(*this, FIX::NBBOSource);
    };
    FIELD_SET(*this, FIX::SettlType);
    FIELD_SET(*this, FIX::SettlDate);
    FIELD_SET(*this, FIX::TerminationDate);
    ...
    FIELD_SET(*this, FIX::NoTradeQtys);
    class NoTradeQtys: public FIX::Group
    {
    public:
    NoTradeQtys() : FIX::Group(1841,1842,FIX::message_order(1842,1843,0)) {}
    ...
    NoSides() : FIX::Group(552,54,FIX::message_order(54,2102,1427,1428,1429,1009,1597,1599,1598,1005,1506,1507,1006,1007,83,1008,430,1154,2901,1155,2902,453,1671,1,660,581,522,1630,81,575,576,635,1971,2671,2418,578,579,376,2404,2351,2352,377,582,336,625,943,2356,12,13,479,2922,1233,1238,497,2639,157,230,158,159,738,920,921,922,238,237,118,119,155,156,77,58,354,355,752,518,232,136,825,826,1848,1730,2771,2759,2767,1853,1854,1852,591,70,78,1016,1158,1072,1057,1139,1690,1115,1444,1851,37,198,11,526,66,1080,1081,1431,1091,40,44,99,18,39,151,14,59,126,2362,2964,1629,1916,528,529,775,1432,1724,2704,821,1093,483,586,2766,1031,1032,702,1855,1861,1980,2344,29,2334,2335,2361,2691,0)) {}
      ...
      FIELD_SET(*this, FIX::SideClearingTradePrice);
      FIELD_SET(*this, FIX::SidePriceDifferential);
      FIELD_SET(*this, FIX::SideClearingTradePriceType);
      FIELD_SET(*this, FIX::SideTradeReportID);
      FIELD_SET(*this, FIX::SideTradeID);
      FIELD_SET(*this, FIX::SideOrigTradeID);
      FIELD_SET(*this, FIX::SideFillStationCd);
      FIELD_SET(*this, FIX::SideReasonCd);
      FIELD_SET(*this, FIX::RptSeq);
      FIELD_SET(*this, FIX::SideTrdSubType);
      FIELD_SET(*this, FIX::NetGrossInd);
      FIELD_SET(*this, FIX::SideCurrency);
      FIELD_SET(*this, FIX::SideCurrencyCodeSource);
      FIELD_SET(*this, FIX::SideSettlCurrency);
      FIELD_SET(*this, FIX::SideSettlCurrencyCodeSource);
      ...
      FIELD_SET(*this, FIX::NoLimitAmts);
      class NoLimitAmts: public FIX::Group
      {
      public:
      NoLimitAmts() : FIX::Group(1630,1631,FIX::message_order(1631,1632,1633,2394,2395,1634,2935,2396,0)) {}
        FIELD_SET(*this, FIX::LimitAmtType);
        FIELD_SET(*this, FIX::LastLimitAmt);
        FIELD_SET(*this, FIX::LimitAmtRemaining);
        FIELD_SET(*this, FIX::LimitUtilizationAmt);
        FIELD_SET(*this, FIX::LimitAmt);
        FIELD_SET(*this, FIX::LimitAmtCurrency);
        FIELD_SET(*this, FIX::LimitAmtCurrencyCodeSource);
        FIELD_SET(*this, FIX::LimitRole);
      };
      ...
      FIELD_SET(*this, FIX::NoSideRegulatoryTradeIDs);
      class NoSideRegulatoryTradeIDs: public FIX::Group
      {
      public:
      NoSideRegulatoryTradeIDs() : FIX::Group(1971,1972,FIX::message_order(1972,1973,1974,1975,2416,2398,0)) {}
        FIELD_SET(*this, FIX::SideRegulatoryTradeID);
        FIELD_SET(*this, FIX::SideRegulatoryTradeIDSource);
        FIELD_SET(*this, FIX::SideRegulatoryTradeIDEvent);
        FIELD_SET(*this, FIX::SideRegulatoryTradeIDType);
        FIELD_SET(*this, FIX::SideRegulatoryLegRefID);
        FIELD_SET(*this, FIX::SideRegulatoryTradeIDScope);
      };
      FIELD_SET(*this, FIX::SideTradeReportingIndicator);
      FIELD_SET(*this, FIX::FirmTradeEventID);
      FIELD_SET(*this, FIX::TradeInputSource);
      FIELD_SET(*this, FIX::TradeInputDevice);
      FIELD_SET(*this, FIX::ComplianceID);
      FIELD_SET(*this, FIX::ComplianceText);
      FIELD_SET(*this, FIX::EncodedComplianceTextLen);
      FIELD_SET(*this, FIX::EncodedComplianceText);
      FIELD_SET(*this, FIX::SolicitedFlag);
      FIELD_SET(*this, FIX::CustOrderCapacity);
      FIELD_SET(*this, FIX::TradingSessionID);
      FIELD_SET(*this, FIX::TradingSessionSubID);
      FIELD_SET(*this, FIX::TimeBracket);
      FIELD_SET(*this, FIX::RemunerationIndicator);
      FIELD_SET(*this, FIX::Commission);
      FIELD_SET(*this, FIX::CommType);
      FIELD_SET(*this, FIX::CommCurrency);
      FIELD_SET(*this, FIX::CommCurrencyCodeSource);
      FIELD_SET(*this, FIX::CommRate);
      FIELD_SET(*this, FIX::CommUnitOfMeasure);
      FIELD_SET(*this, FIX::FundRenewWaiv);
      FIELD_SET(*this, FIX::NoCommissions);
      class NoCommissions: public FIX::Group
      {
      public:
      NoCommissions() : FIX::Group(2639,2640,FIX::message_order(2640,2641,2725,2642,2643,2923,2644,2645,2924,2646,2647,2648,2649,2650,2651,2652,0)) {}
        FIELD_SET(*this, FIX::CommissionAmount);
        FIELD_SET(*this, FIX::CommissionAmountType);
        FIELD_SET(*this, FIX::CommissionAmountSubType);
        FIELD_SET(*this, FIX::CommissionBasis);
        FIELD_SET(*this, FIX::CommissionCurrency);
        FIELD_SET(*this, FIX::CommissionCurrencyCodeSource);
        FIELD_SET(*this, FIX::CommissionUnitOfMeasure);
        FIELD_SET(*this, FIX::CommissionUnitOfMeasureCurrency);
        FIELD_SET(*this, FIX::CommissionUnitOfMeasureCurrencyCodeSource);
        FIELD_SET(*this, FIX::CommissionRate);
        FIELD_SET(*this, FIX::CommissionSharedIndicator);
        FIELD_SET(*this, FIX::CommissionAmountShared);
        FIELD_SET(*this, FIX::CommissionLegRefID);
        FIELD_SET(*this, FIX::CommissionDesc);
        FIELD_SET(*this, FIX::EncodedCommissionDescLen);
        FIELD_SET(*this, FIX::EncodedCommissionDesc);
      };
      ...
      FIELD_SET(*this, FIX::TradeAllocGroupInstruction);
      FIELD_SET(*this, FIX::AllocGroupID);
      FIELD_SET(*this, FIX::PreviousAllocGroupID);
      FIELD_SET(*this, FIX::GroupAmount);
      FIELD_SET(*this, FIX::AllocGroupStatus);
      FIELD_SET(*this, FIX::SideAvgPxIndicator);
      FIELD_SET(*this, FIX::SideAvgPxGroupID);
      FIELD_SET(*this, FIX::SideAvgPx);
      ...
      {
      public:
      NoAllocs() : FIX::Group(78,79,FIX::message_order(79,661,736,2927,467,1593,2727,1908,1729,756,209,80,2515,1752,1753,1754,1755,993,1002,989,1136,1844,1840,1735,161,360,361,1732,1733,1734,2392,2393,2653,0)) {}
        FIELD_SET(*this, FIX::AllocAccount);
        FIELD_SET(*this, FIX::AllocAcctIDSource);
        FIELD_SET(*this, FIX::AllocSettlCurrency);
        FIELD_SET(*this, FIX::AllocSettlCurrencyCodeSource);
        ...
        FIELD_SET(*this, FIX::NoTradeAllocAmts);
        class NoTradeAllocAmts: public FIX::Group
        {
        public:
        NoTradeAllocAmts() : FIX::Group(1844,1845,FIX::message_order(1845,1846,1847,2933,1850,0)) {}
          FIELD_SET(*this, FIX::TradeAllocAmtType);
          FIELD_SET(*this, FIX::TradeAllocAmt);
          FIELD_SET(*this, FIX::TradeAllocCurrency);
          FIELD_SET(*this, FIX::TradeAllocCurrencyCodeSource);
          FIELD_SET(*this, FIX::TradeAllocAmtReason);
        };
        FIELD_SET(*this, FIX::TradeAllocStatus);
        FIELD_SET(*this, FIX::AllocationRollupInstruction);
        ...
        FIELD_SET(*this, FIX::AllocRefRiskLimitCheckID);
        FIELD_SET(*this, FIX::AllocRefRiskLimitCheckIDType);
        FIELD_SET(*this, FIX::NoAllocCommissions);
        class NoAllocCommissions: public FIX::Group
        {
        public:
        NoAllocCommissions() : FIX::Group(2653,2654,FIX::message_order(2654,2655,2726,2656,2657,2925,2658,2659,2926,2660,2661,2662,2663,2664,2665,2666,0)) {}
          FIELD_SET(*this, FIX::AllocCommissionAmount);
          FIELD_SET(*this, FIX::AllocCommissionAmountType);
          FIELD_SET(*this, FIX::AllocCommissionAmountSubType);
          FIELD_SET(*this, FIX::AllocCommissionBasis);
          FIELD_SET(*this, FIX::AllocCommissionCurrency);
          FIELD_SET(*this, FIX::AllocCommissionCurrencyCodeSource);
          FIELD_SET(*this, FIX::AllocCommissionUnitOfMeasure);
          FIELD_SET(*this, FIX::AllocCommissionUnitOfMeasureCurrency);
          FIELD_SET(*this, FIX::AllocCommissionUnitOfMeasureCurrencyCodeSource);
          FIELD_SET(*this, FIX::AllocCommissionRate);
          FIELD_SET(*this, FIX::AllocCommissionSharedIndicator);
          FIELD_SET(*this, FIX::AllocCommissionAmountShared);
          FIELD_SET(*this, FIX::AllocCommissionLegRefID);
          FIELD_SET(*this, FIX::AllocCommissionDesc);
          FIELD_SET(*this, FIX::EncodedAllocCommissionDescLen);
          FIELD_SET(*this, FIX::EncodedAllocCommissionDesc);
        };
      };
      ...
      {
      public:
      NoSettlDetails() : FIX::Group(1158,1164,FIX::message_order(1164,169,170,171,781,0)) {}
      ...
      FIELD_SET(*this, FIX::SideShortSaleExemptionReason);
      ...
      {
      public:
      NoOrders() : FIX::Group(73,2887,FIX::message_order(2887,2888,2836,2889,2890,2835,0)) {}
        FIELD_SET(*this, FIX::RelatedOrderID);
        FIELD_SET(*this, FIX::RelatedOrderIDSource);
        FIELD_SET(*this, FIX::RelatedOrderTime);
        FIELD_SET(*this, FIX::RelatedOrderQty);
        FIELD_SET(*this, FIX::OrderRelationship);
        FIELD_SET(*this, FIX::OrderOriginationFirmID);
      };
      ...
      FIELD_SET(*this, FIX::NoMatchInst);
      class NoMatchInst: public FIX::Group
      {
      public:
      NoMatchInst() : FIX::Group(1624,1625,FIX::message_order(1625,1673,1626,1627,0)) {}
        FIELD_SET(*this, FIX::MatchInst);
        FIELD_SET(*this, FIX::MatchInstMarketID);
        FIELD_SET(*this, FIX::MatchAttribTagID);
        FIELD_SET(*this, FIX::MatchAttribValue);
      };
      FIELD_SET(*this, FIX::SelfMatchPreventionID);
      FIELD_SET(*this, FIX::SelfMatchPreventionInstruction);
      ...
      FIELD_SET(*this, FIX::InitialDisplayQty);
      FIELD_SET(*this, FIX::CurrentDisplayPrice);
      ...
      FIELD_SET(*this, FIX::ExDestinationType);
      ...
      FIELD_SET(*this, FIX::OrderPercentOfTotalVolume);
      ...
      {
      public:
      NoPositions() : FIX::Group(702,703,FIX::message_order(703,704,705,1654,706,976,0)) {}
        FIELD_SET(*this, FIX::PosType);
        FIELD_SET(*this, FIX::LongQty);
        FIELD_SET(*this, FIX::ShortQty);
        FIELD_SET(*this, FIX::CoveredQty);
      ...
      FIELD_SET(*this, FIX::NoRelatedPositions);
      class NoRelatedPositions: public FIX::Group
      {
      public:
      NoRelatedPositions() : FIX::Group(1861,1862,FIX::message_order(1862,1863,1864,0)) {}
        FIELD_SET(*this, FIX::RelatedPositionID);
        FIELD_SET(*this, FIX::RelatedPositionIDSource);
        FIELD_SET(*this, FIX::RelatedPositionDate);
      };
      FIELD_SET(*this, FIX::BlockTrdAllocIndicator);
      FIELD_SET(*this, FIX::SideRiskLimitCheckStatus);
      FIELD_SET(*this, FIX::LastCapacity);
      FIELD_SET(*this, FIX::RefRiskLimitCheckID);
      FIELD_SET(*this, FIX::RefRiskLimitCheckIDType);
      FIELD_SET(*this, FIX::CompressionGroupID);
      FIELD_SET(*this, FIX::NoSideCollateralAmounts);
      class NoSideCollateralAmounts: public FIX::Group
      {
      public:
      NoSideCollateralAmounts() : FIX::Group(2691,2702,FIX::message_order(2702,2695,2930,2694,2696,2697,2701,2693,2692,2703,2700,2699,2698,2862,2864,2863,0)) {}
        FIELD_SET(*this, FIX::SideCurrentCollateralAmount);
        FIELD_SET(*this, FIX::SideCollateralCurrency);
        FIELD_SET(*this, FIX::SideCollateralCurrencyCodeSource);
        FIELD_SET(*this, FIX::SideCollateralAmountType);
        FIELD_SET(*this, FIX::SideCollateralFXRate);
        FIELD_SET(*this, FIX::SideCollateralFXRateCalc);
        FIELD_SET(*this, FIX::SideCollateralType);
        FIELD_SET(*this, FIX::SideCollateralAmountMarketSegmentID);
        FIELD_SET(*this, FIX::SideCollateralAmountMarketID);
        FIELD_SET(*this, FIX::SideHaircutIndicator);
        FIELD_SET(*this, FIX::SideCollateralPortfolioID);
        FIELD_SET(*this, FIX::SideCollateralPercentOverage);
        FIELD_SET(*this, FIX::SideCollateralMarketPrice);
        FIELD_SET(*this, FIX::SideCollateralReinvestmentRate);
        FIELD_SET(*this, FIX::NoSideCollateralReinvestments);
        class NoSideCollateralReinvestments: public FIX::Group
        {
        public:
        NoSideCollateralReinvestments() : FIX::Group(2864,2867,FIX::message_order(2867,2865,2866,2932,0)) {}
          FIELD_SET(*this, FIX::SideCollateralReinvestmentType);
          FIELD_SET(*this, FIX::SideCollateralReinvestmentAmount);
          FIELD_SET(*this, FIX::SideCollateralReinvestmentCurrency);
          FIELD_SET(*this, FIX::SideCollateralReinvestmentCurrencyCodeSource);
        };
        FIELD_SET(*this, FIX::SideUnderlyingRefID);
      };
    };
    ...
    FIELD_SET(*this, FIX::TradeReportingIndicator);
    ...
    FIELD_SET(*this, FIX::TotalGrossTradeAmt);
    ...
    FIELD_SET(*this, FIX::ClearingIntention);
    FIELD_SET(*this, FIX::TradeClearingInstruction);
    FIELD_SET(*this, FIX::BackloadedTradeIndicator);
    FIELD_SET(*this, FIX::ConfirmationMethod);
    FIELD_SET(*this, FIX::MandatoryClearingIndicator);
    FIELD_SET(*this, FIX::NoMandatoryClearingJurisdictions);
    class NoMandatoryClearingJurisdictions: public FIX::Group
    {
    public:
    NoMandatoryClearingJurisdictions() : FIX::Group(41312,41313,FIX::message_order(41313,0)) {}
      FIELD_SET(*this, FIX::MandatoryClearingJurisdiction);
    };
    FIELD_SET(*this, FIX::MixedSwapIndicator);
    FIELD_SET(*this, FIX::MultiAssetSwapIndicator);
    FIELD_SET(*this, FIX::InternationalSwapIndicator);
    FIELD_SET(*this, FIX::OffMarketPriceIndicator);
    FIELD_SET(*this, FIX::VerificationMethod);
    FIELD_SET(*this, FIX::ClearingRequirementException);
    FIELD_SET(*this, FIX::IRSDirection);
    FIELD_SET(*this, FIX::RegulatoryReportType);
    FIELD_SET(*this, FIX::RegulatoryReportTypeBusinessDate);
    FIELD_SET(*this, FIX::VoluntaryRegulatoryReport);
    FIELD_SET(*this, FIX::MultiJurisdictionReportingIndicator);
    FIELD_SET(*this, FIX::TradeCollateralization);
    FIELD_SET(*this, FIX::TradeContinuation);
    FIELD_SET(*this, FIX::TradeContingency);
    FIELD_SET(*this, FIX::TradeVersion);
    FIELD_SET(*this, FIX::HistoricalReportIndicator);
    FIELD_SET(*this, FIX::DeltaCrossed);
    FIELD_SET(*this, FIX::TradeContinuationText);
    FIELD_SET(*this, FIX::EncodedTradeContinuationTextLen);
    FIELD_SET(*this, FIX::EncodedTradeContinuationText);
    FIELD_SET(*this, FIX::IntraFirmTradeIndicator);
    FIELD_SET(*this, FIX::AffiliatedFirmsTradeIndicator);
    FIELD_SET(*this, FIX::NoAttachments);
    class NoAttachments: public FIX::Group
    {
    public:
    NoAttachments() : FIX::Group(2104,2105,FIX::message_order(2105,2106,2107,2108,2109,2110,2111,2112,2113,0)) {}
      FIELD_SET(*this, FIX::AttachmentName);
      FIELD_SET(*this, FIX::AttachmentMediaType);
      FIELD_SET(*this, FIX::AttachmentClassification);
      FIELD_SET(*this, FIX::AttachmentExternalURL);
      FIELD_SET(*this, FIX::AttachmentEncodingType);
      FIELD_SET(*this, FIX::UnencodedAttachmentLen);
      FIELD_SET(*this, FIX::EncodedAttachmentLen);
      FIELD_SET(*this, FIX::EncodedAttachment);
      FIELD_SET(*this, FIX::NoAttachmentKeywords);
      class NoAttachmentKeywords: public FIX::Group
      {
      public:
      NoAttachmentKeywords() : FIX::Group(2113,2114,FIX::message_order(2114,0)) {}
        FIELD_SET(*this, FIX::AttachmentKeyword);
      };
    };
    FIELD_SET(*this, FIX::RiskLimitCheckStatus);
  };
