#ifndef FIX50SP2_MARGINREQUIREMENTREPORT_H
#define FIX50SP2_MARGINREQUIREMENTREPORT_H
...
namespace FIX50SP2
{
  ...
  class MarginRequirementReport : public Message
  {
  public:
    MarginRequirementReport() : Message(MsgType()) {}
    MarginRequirementReport(const FIX::Message& m) : Message(m) {}
    MarginRequirementReport(const Message& m) : Message(m) {}
    MarginRequirementReport(const MarginRequirementReport&) = default;
    MarginRequirementReport(MarginRequirementReport&&) = default;
    MarginRequirementReport& operator=(const MarginRequirementReport&) = default;
    MarginRequirementReport& operator=(MarginRequirementReport&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("CJ"); }

    MarginRequirementReport(
      const FIX::MarginReqmtRptID& aMarginReqmtRptID,
      const FIX::MarginReqmtRptType& aMarginReqmtRptType )
    : Message(MsgType())
    {
      set(aMarginReqmtRptID);
      set(aMarginReqmtRptType);
    }
    ...
    FIELD_SET(*this, FIX::MarginReqmtRptID);
    FIELD_SET(*this, FIX::MarginReqmtInqID);
    FIELD_SET(*this, FIX::MarginReqmtRptType);
    ...
    FIELD_SET(*this, FIX::MarginClass);
