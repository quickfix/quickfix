#ifndef FIX50SP2_TRADEAGGREGATIONREQUEST_H
#define FIX50SP2_TRADEAGGREGATIONREQUEST_H
...
namespace FIX50SP2
{
  ...
  class TradeAggregationRequest : public Message
  {
  public:
    TradeAggregationRequest() : Message(MsgType()) {}
    TradeAggregationRequest(const FIX::Message& m) : Message(m) {}
    TradeAggregationRequest(const Message& m) : Message(m) {}
    TradeAggregationRequest(const TradeAggregationRequest&) = default;
    TradeAggregationRequest(TradeAggregationRequest&&) = default;
    TradeAggregationRequest& operator=(const TradeAggregationRequest&) = default;
    TradeAggregationRequest& operator=(TradeAggregationRequest&&) = default;
    static FIX::MsgType MsgType() { return FIX::MsgType("DW"); }

    TradeAggregationRequest(
      const FIX::TradeAggregationRequestID& aTradeAggregationRequestID,
      const FIX::TradeAggregationTransType& aTradeAggregationTransType,
      const FIX::Side& aSide )
    : Message(MsgType())
    {
      set(aTradeAggregationRequestID);
      set(aTradeAggregationTransType);
      set(aSide);
    }

    FIELD_SET(*this, FIX::TradeAggregationRequestID);
    FIELD_SET(*this, FIX::TradeAggregationRequestRefID);
    FIELD_SET(*this, FIX::TradeAggregationTransType);
    FIELD_SET(*this, FIX::AggregatedQty);
    ...
    {
    public:
    NoOrders() : FIX::Group(73,11,FIX::message_order(11,37,38,799,0)) {}
    ...
    {
    public:
    NoExecs() : FIX::Group(124,32,FIX::message_order(32,17,1003,31,0)) {}
