...
static const std::string VALIDATE_USER_DEFINED_FIELDS = "ValidateUserDefinedFields";
static const std::string LOGON_TIMEOUT = "LogonTimeout";
static const std::string FILE_PATH = "FilePath";
static const std::string MYSQL_DATABASE = "MySQLDatabase";
static const std::string MYSQL_USER = "MySQLUser";
static const std::string MYSQL_PASSWORD = "MySQLPassword";
static const std::string MYSQL_HOST = "MySQLHost";
static const std::string MYSQL_PORT = "MySQLPort";
static const std::string POSTGRESQL_DATABASE = "PostgreSQLDatabase";
static const std::string POSTGRESQL_USER = "PostgreSQLUser";
static const std::string POSTGRESQL_PASSWORD = "PostgreSQLPassword";
static const std::string POSTGRESQL_HOST = "PostgreSQLHost";
static const std::string POSTGRESQL_PORT = "PostgreSQLPort";
...
static const std::string POSTGRESQL_STORE_DATABASE = "PostgreSQLStoreDatabase";
static const std::string POSTGRESQL_STORE_USER = "PostgreSQLStoreUser";
static const std::string POSTGRESQL_STORE_PASSWORD = "PostgreSQLStorePassword";
static const std::string POSTGRESQL_STORE_HOST = "PostgreSQLStoreHost";
static const std::string POSTGRESQL_STORE_PORT = "PostgreSQLStorePort";
static const std::string FILE_LOG_PATH = "FileLogPath";
static const std::string MYSQL_LOG_DATABASE = "MySQLLogDatabase";
static const std::string MYSQL_LOG_USER = "MySQLLogUser";
static const std::string MYSQL_LOG_PASSWORD = "MySQLLogPassword";
static const std::string MYSQL_LOG_HOST = "MySQLLogHost";
static const std::string MYSQL_LOG_PORT = "MySQLLogPort";
static const std::string POSTGRESQL_LOG_DATABASE = "PostgreSQLLogDatabase";
static const std::string POSTGRESQL_LOG_USER = "PostgreSQLLogUser";
static const std::string POSTGRESQL_LOG_PASSWORD = "PostgreSQLLogPassword";
static const std::string POSTGRESQL_LOG_HOST = "PostgreSQLLogHost";
static const std::string POSTGRESQL_LOG_PORT = "PostgreSQLLogPort";
