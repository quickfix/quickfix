...
TEST(socketHostName_SocketName_SocketNameUnknown)
{
  std::string unknown = "unknown";
  CHECK(0 == socket_hostname(unknown.c_str()));
}

TEST(socketHostName_SocketNameIsNull_SocketNameUnknown)
{
  const char* unknown;
  CHECK(0 == socket_hostname(unknown));
}
