...
TEST(TimeRangeTests, isInRange_UseLocalTime)
{
  ...
  ASSERT_TRUE( timeRange.isInRange( now ) );

}

TEST(TimeRangeTests, isInRangeWithDay)
{
  ...
  ASSERT_TRUE(TimeRange::isInRange(startTime, endTime, startDay, endDay, now));
...
TEST(TimeRangeTests, isInRangeWithDay_SameDay)
{
  UtcTimeOnly startTime( 3, 0, 0 );
  UtcTimeOnly endTime( 18, 0, 0 );
  int startDay = 2;
...
TEST(TimeRangeTests, isInSameRange)
{
  ...
  ASSERT_TRUE( TimeRange::isInSameRange( start, end, time1, time2 ) );
  ASSERT_TRUE( TimeRange::isInSameRange( start, end, time2, time1 ) );
...
TEST(TimeRangeTests, isInSameRange_UseLocalTime)
{
  LocalTimeOnly start( 0, 0, 0 );
  LocalTimeOnly end( 1, 0, 0 );
  ...
  ASSERT_TRUE( timeRange.isInSameRange(time1, time2) );

}

TEST(TimeRangeTests, isInSameRangeWithDay)
{
  UtcTimeOnly startTime( 3, 0, 0 );
  UtcTimeOnly endTime( 18, 0, 0 );
  int startDay = 2;
  ...
  ASSERT_TRUE( !TimeRange::isInSameRange
  ...
  ASSERT_TRUE( TimeRange::isInSameRange(startTime, endTime, startDay, endDay, time1, time2) );
