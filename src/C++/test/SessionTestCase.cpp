...
TEST_FIXTURE(initiatorFixture, NextMessage_MessageParsingErrorOnValidate) {
  ...
  provider.addTransportDataDictionary( sessionID.getBeginString(), "../spec/FIX42.xml" );
  DataDictionary dictionary = provider.getSessionDataDictionary(sessionID.getBeginString());
  ExceptionDataDictionary exceptionDictionary(dictionary, ExceptionDataDictionary::MESSAGE_PARSE_ERROR);

  std::shared_ptr<ExceptionDataDictionary> pDataDictionary = std::make_shared<ExceptionDataDictionary>(exceptionDictionary);
  provider.addTransportDataDictionary( sessionID.getBeginString(), pDataDictionary );
  ...
  pDataDictionary->shouldThrowException = true;
  FIX42::NewOrderSingle newOrderSingle = createNewOrderSingle( "ISLD", "TW", 2 );
  object->next( newOrderSingle, UtcTimeStamp() );

  CHECK_EQUAL(3, object->getExpectedSenderNum());//Message seqnum still increases
  CHECK_EQUAL(2, object->getExpectedTargetNum());

}


TEST_FIXTURE(initiatorFixture, NextMessage_IncorrectTagValueOnValidate_Rejected) {
  ...
  provider.addTransportDataDictionary( sessionID.getBeginString(), "../spec/FIX42.xml" );
  DataDictionary dictionary = provider.getSessionDataDictionary(sessionID.getBeginString());
  ExceptionDataDictionary exceptionDictionary(dictionary, ExceptionDataDictionary::INCORRECT_TAG_VALUE);
...
TEST_FIXTURE(initiatorFixture, NextMessage_RequiredTagMissing_Rejected) {
  ...
  provider.addTransportDataDictionary( sessionID.getBeginString(), "../spec/FIX42.xml" );
  DataDictionary dictionary = provider.getSessionDataDictionary(sessionID.getBeginString());
  ExceptionDataDictionary exceptionDictionary(dictionary, ExceptionDataDictionary::REQUIRED_TAG_MISSING);
...
TEST_FIXTURE(initiatorFixture, NextMessage_RejectLogonOnValidate_SessionDisconnected) {
  ...
  provider.addTransportDataDictionary( sessionID.getBeginString(), "../spec/FIX42.xml" );
  DataDictionary dictionary = provider.getSessionDataDictionary(sessionID.getBeginString());
  ExceptionDataDictionary exceptionDictionary(dictionary, ExceptionDataDictionary::REJECT_LOGON);
...
TEST_FIXTURE(initiatorFixture, NextMessage_IOExceptionOnValidate_SessionDisconnected) {
  ...
  provider.addTransportDataDictionary( sessionID.getBeginString(), "../spec/FIX42.xml" );
  DataDictionary dictionary = provider.getSessionDataDictionary(sessionID.getBeginString());
  ExceptionDataDictionary exceptionDictionary(dictionary, ExceptionDataDictionary::IO_EXCEPTION);
