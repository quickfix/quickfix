...
namespace FIX43
{
  ...
  public:
    ...
    {
    public:
    NoLegs() : FIX::Group(555,564,FIX::message_order(600,601,602,603,607,608,609,610,611,248,249,250,251,252,253,257,599,596,597,598,254,612,613,614,615,616,617,618,619,620,621,622,623,624,564,565,654,566,587,588,0)) {}
