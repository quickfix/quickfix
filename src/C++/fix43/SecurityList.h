...
namespace FIX43
{
  ...
  public:
    ...
    {
    public:
    NoRelatedSym() : FIX::Group(146,15,FIX::message_order(55,65,48,22,460,461,167,200,541,224,225,239,226,227,228,255,543,470,471,472,240,202,206,231,223,207,106,348,349,107,350,351,15,561,562,336,625,58,354,355,0)) {}
      ...
      {
      public:
      NoLegs() : FIX::Group(555,556,FIX::message_order(600,601,602,603,607,608,609,610,611,248,249,250,251,252,253,257,599,596,597,598,254,612,613,614,615,616,617,618,619,620,621,622,623,624,556,0)) {}
