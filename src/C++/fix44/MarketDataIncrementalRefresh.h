...
namespace FIX44
{
  ...
  public:
    ...
    {
    public:
    NoMDEntries() : FIX::Group(268,279,FIX::message_order(279,285,269,278,291,292,270,15,271,272,273,274,275,336,625,276,277,282,283,284,286,59,432,126,110,18,287,37,299,288,289,346,290,546,811,451,58,354,355,0)) {}
      ...
      class MDEntryRefID: public FIX::Group
      {
      public:
      MDEntryRefID() : FIX::Group(280,55,FIX::message_order(55,65,48,22,460,461,167,762,200,541,224,225,239,226,227,228,255,543,470,471,472,240,202,947,206,231,223,207,106,348,349,107,350,351,691,667,875,876,873,874,0)) {}
