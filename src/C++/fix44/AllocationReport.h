...
namespace FIX44
{
  ...
  public:
    ...
    {
    public:
    NoAllocs() : FIX::Group(78,79,FIX::message_order(79,661,573,366,80,467,81,208,209,161,360,361,38,152,516,468,469,153,154,119,737,120,736,155,156,742,741,635,780,172,169,170,171,0)) {}
