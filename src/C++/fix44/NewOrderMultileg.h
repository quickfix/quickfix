...
namespace FIX44
{
  ...
  public:
    ...
    {
    public:
    NoAllocs() : FIX::Group(78,79,FIX::message_order(79,661,736,467,80,0)) {}
      ...
      {
      public:
      NoNested3PartyIDs() : FIX::Group(948,949,FIX::message_order(949,950,951,0)) {}
    ...
    {
    public:
    NoLegs() : FIX::Group(555,600,FIX::message_order(600,601,602,603,607,608,609,764,610,611,248,249,250,251,252,253,257,599,596,597,598,254,612,942,613,614,615,616,617,618,619,620,621,622,623,624,556,740,739,955,956,687,690,564,565,654,566,587,588,0)) {}
      ...
      {
      public:
      NoLegAllocs() : FIX::Group(670,671,FIX::message_order(671,672,673,674,675,0)) {}
