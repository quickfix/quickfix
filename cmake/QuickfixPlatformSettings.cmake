...
if(NOT WIN32)
  find_file (FOUND_ALLOCATOR_HDR NAMES Allocator.h PATHS ${CMAKE_CURRENT_SOURCE_DIR}/src/C++/ NO_DEFAULT_PATH)
if (NOT FOUND_ALLOCATOR_HDR)
message("-- Generating empty Allocator.h")
file(WRITE ${CMAKE_CURRENT_SOURCE_DIR}/src/C++/Allocator.h
     "/* Empty file generated by cmake, can be replaced by a custom file */\n"
 )
endif()

find_file (FOUND_CONFIG_HDR NAMES config.h PATHS ${CMAKE_CURRENT_SOURCE_DIR} NO_DEFAULT_PATH)
