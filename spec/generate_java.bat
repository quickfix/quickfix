...
msxsl FIX44.xml java_Message.xsl -o ..\src\java\src\org\quickfix\fix44\Message.java
...
msxsl FIX44.xml generate_java_messages.xsl -o generate_java_messages44.bat
...
call generate_java_messages44.bat